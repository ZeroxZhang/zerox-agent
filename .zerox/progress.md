...
- Active iteration: Agent Capability P2.3 research writing tools.
...
- Latest focused checks:
  ...
  - `npm run verify` → 87 Vitest files / 386 tests, agent eval 11/11, memory eval 2/2
  - `npm run harness:score` → score 9.31/10, agent eval 11/11
  - `npm run smoke:prod` → renderer rendered agent chat UI
- Current focus: implement P2.4 child handoff review gate.
