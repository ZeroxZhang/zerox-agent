...
} from "./check-conversation-disclosure-continuation-v2.mjs";
...
if (diagnosticOnly) {
  ...
  console.log(JSON.stringify({
    ...
    digest: hashCanonicalV2(diagnosticWithoutDigest),
  }));
} else {
  ...
  console.log("Harness continuation v2 check passed.");
  console.log(JSON.stringify({
    ...receiptWithoutDigest,
    digest: hashCanonicalV2(receiptWithoutDigest),
  }));
}
...
function fail() {
  console.error("Harness continuation v2 check failed:");
