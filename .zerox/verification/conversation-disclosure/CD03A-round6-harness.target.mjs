...
} from "./check-conversation-disclosure-continuation-v6.mjs";
...
if (requestedArguments.includes("--diagnostic-only") && !diagnosticOnly) {
  console.error("Harness continuation v6 check failed:");
...
if (diagnosticOnly) {
  ...
  console.log(JSON.stringify({
    ...
    digest: hashCanonicalV6(diagnosticWithoutDigest),
  }));
} else {
  ...
  console.log("Harness continuation v6 check passed.");
  console.log(JSON.stringify({
