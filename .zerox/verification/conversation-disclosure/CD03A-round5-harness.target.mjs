...
} from "./check-conversation-disclosure-continuation-v5.mjs";
...
if (requestedArguments.includes("--diagnostic-only") && !diagnosticOnly) {
  console.error("Harness continuation v5 check failed:");
...
if (diagnosticOnly) {
  ...
  console.log(JSON.stringify({
    ...
    digest: hashCanonicalV5(diagnosticWithoutDigest),
  }));
} else {
  ...
  console.log("Harness continuation v5 check passed.");
  console.log(JSON.stringify({
