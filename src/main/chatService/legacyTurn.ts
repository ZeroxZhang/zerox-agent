import { toRelatedMemory, estimateChatTurnUsage, recordSessionTokenUsage, toPersistedChatContinuation, reconcileAgentLoopTokenUsage, buildNativeToolEvidencePayload, getNativeToolDescriptor, truncateHistoryContent, formatContextUsageStatus, toChatSessionContextSnapshot, toChatSessionTokenUsage, mergeChatSessionTokenUsage, buildChatSystemPrompt, getToolRegistrySource, injectSkillInvocationMessage, createHistoryAttachmentReplayBudget, buildChatMessages, searchRelatedMemories, tryRunTaskFromIntent, writeAtomicMemories, compactMessageIds, writeSessionMemory, tryCreateTaskFromIntent, toInMemoryPendingSkillInputState, createPendingSkillInputState, createSkillUserInputRequest, resolveRequestedSkill, findPersistedChatContinuation, appendRawHistoryEntry, appendAssistantMessage, findPersistedRequestTurn, persistRequiredChatActivityEvent } from "./modulemessages";
...
import { modelNoticeContinuationReason, formatAgentLoopFailure, normalizeReasoningForStatus, emitActorToolStatusEvents, buildToolResultStatusMessage, emitActorSpawnedStatusEvent, readToolArgString, buildRuntimeContextMemoryScopes, createChatRuntimeTask, extendRunContextForSelectedSkill, buildContinuationMessages, detectGoalIntent, extractGoalDescription, tryRouteGoalIntent, isContinuationRequest, formatPlanContinuationReply, isAbortError, formatLockedPlanReply, extractExplicitGoalAmendmentObjective, getActiveGoalSummary, buildChatWorkspaceSummary, resolveChatWorkspace, createChatWorkspaceRunId } from "./moduleruntime";
import { inferApprovalRiskLevel, createChatWorkspaceRunRecorder, commitPreparedAssistantAcceptance, settlePreparedWorkspaceAssistantAcceptance, persistRequiredConversationSettlement, ChatWorkspaceRunRecorder } from "./modulesettlement";
import { stringifyMaskedPreview, ChatOutputPart } from "../../shared/chatOutput";
import { stringifyRedactedCredentials, redactCredentialString } from "../../shared/credentialRedaction";
import { emitModelStreamEvent, normalizeAgentLoopMaxTurns, createChatStatusEmitter, getNowMs } from "./streamingStatus";
...
import { ChatSessionTokenUsage, ChatAgentStatus, ChatSessionGoalSummary, ChatHistoryMessage, ChatTurnSettlementStatus, ChatTaskStatusEvent, SendChatMessageResult, SendChatMessageInput } from "../../shared/chat";
...
import { toSecretSafeFailure, SecretSafeFailureError } from "../../shared/secretSafeFailure";
import { WorkspaceRunEnvelopeConflictError } from "../workspaceRunStore";
import { createConversationRequestFingerprint, createConversationCausalAttemptId, LEGACY_CONVERSATION_REQUEST_FINGERPRINT_VERSION, resolveConversationRequestFingerprintVersion, resolveDurableConversationBinding, createConversationTurnId } from "../../shared/conversationCausalSpine";
import { createAssistantAcceptanceRecoveryResult, AssistantAcceptanceRecoveryRequiredError, RequiredConversationSettlementError, createChatPublicationAuthority, ChatTurnInternalOptions, SendChatMessageRuntimeOptions, ChatServiceOptions, ChatContinuationState } from "../chatService";
