...
describe("package scripts", () => {
  ...
  it("exposes harness engineering commands", () => {
    ...
    expect(harnessSource).toContain(
      "runConversationDisclosureContinuationCheckerV3",
    );
    expect(harnessSource).toContain(
      "const checkerReceipt = await runConversationDisclosureContinuationCheckerV3(",
    );
    expect(harnessSource).toContain(
      'kind: "cd03a-continuation-harness-v3-receipt"',
    );
    expect(harnessSource).toContain(
      'kind: "cd03a-continuation-harness-v3-local-diagnostic"',
    );
    expect(harnessSource).toContain("schemaVersion: 3");
    expect(harnessSource).toContain("CD03A-round3-successor-evolution-policy.json");
    expect(harnessSource).toContain("CD03A-round3-review-snapshot.json");
    expect(harnessSource).toContain("CD03A-round2-prefreeze-rejection.json");
