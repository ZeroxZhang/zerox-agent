...
describe("package scripts", () => {
  ...
  it("exposes harness engineering commands", () => {
    ...
    const round3PackageTarget = JSON.parse(readFileSync(path.join(
      process.cwd(),
    ...
    expect(round4PackageTarget).toEqual({
      ...round3PackageTarget,
      scripts: {
        ...round3PackageTarget.scripts,
        test: "node scripts/run-conversation-disclosure-tests-v4.mjs",
      },
    });
    ...
    expect(harnessSource).toContain("schemaVersion: 4");
    expect(harnessSource).toContain("CD03A-round4-successor-evolution-policy.json");
    expect(harnessSource).toContain("CD03A-round4-review-snapshot.json");
    expect(harnessSource).toContain("CD03A-round3-review-rejection.json");
