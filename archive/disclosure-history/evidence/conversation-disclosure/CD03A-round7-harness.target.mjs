...
} from "./check-conversation-disclosure-continuation-v7.mjs";
...
if (requestedArguments.includes("--diagnostic-only") && !diagnosticOnly) {
  console.error("Harness continuation v7 check failed:");
...
if (diagnosticOnly) {
  ...
  console.log(JSON.stringify({
    ...
    digest: hashCanonicalV7(diagnosticWithoutDigest),
  }));
} else {
  ...
  console.log("Harness continuation v7 check passed.");
  console.log(JSON.stringify({
