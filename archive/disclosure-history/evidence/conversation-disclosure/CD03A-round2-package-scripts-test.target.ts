...
describe("package scripts", () => {
  ...
  it("exposes harness engineering commands", () => {
    ...
    expect(harnessSource).toContain(
      "runConversationDisclosureContinuationCheckerV2",
    );
    expect(harnessSource).toContain(
      "const checkerReceipt = await runConversationDisclosureContinuationCheckerV2(",
    );
    expect(harnessSource).toContain(
      'kind: "cd03a-continuation-harness-v2-receipt"',
    );
    expect(harnessSource).toContain(
      'kind: "cd03a-continuation-harness-v2-local-diagnostic"',
    );
