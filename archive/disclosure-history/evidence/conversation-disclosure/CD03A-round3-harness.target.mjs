...
} from "./check-conversation-disclosure-continuation-v3.mjs";
...
if (diagnosticOnly) {
  ...
  console.log(JSON.stringify({
    ...
    digest: hashCanonicalV3(diagnosticWithoutDigest),
  }));
} else {
  ...
  console.log("Harness continuation v3 check passed.");
  console.log(JSON.stringify({
    ...receiptWithoutDigest,
    digest: hashCanonicalV3(receiptWithoutDigest),
  }));
}
...
function fail() {
  console.error("Harness continuation v3 check failed:");
