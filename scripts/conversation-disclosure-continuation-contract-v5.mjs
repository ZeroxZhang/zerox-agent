...
export const CONTINUATION_V5_ALGORITHM = "sha256-canonical-json-v1";
export const CONTINUATION_V5_POLICY_KIND =
  "conversation-disclosure-continuation-policy";
export const CONTINUATION_V5_SNAPSHOT_KIND =
  "conversation-disclosure-continuation-review-snapshot";
export const CONTINUATION_V5_RECEIPT_KIND =
  "conversation-disclosure-continuation-review-receipt";
export const CONTINUATION_V5_MANIFEST_KIND =
  "conversation-disclosure-continuation-closure-manifest";
export const CONTINUATION_V5_ATTESTATION_KIND =
  "conversation-disclosure-continuation-external-attestation";
export const CONTINUATION_V5_ANCHOR_KIND =
  "conversation-disclosure-continuation-external-anchor";
export const CONTINUATION_V5_REVIEW_REJECTION_KIND =
  "conversation-disclosure-continuation-review-rejection";
export const CONTINUATION_V5_BASELINE_ARCHIVE_KIND =
  "conversation-disclosure-continuation-baseline-archive";

export const CONTINUATION_V5_POLICY_ID = "CD03A-round5-P108-admission-v5";
export const CONTINUATION_V5_WORKSTREAM_ID = "CD03A";
export const CONTINUATION_V5_FEATURE_ID =
  "P107A-conversation-disclosure-successor-admission";
export const CONTINUATION_V5_SUCCESSOR_WORKSTREAM_ID = "CD04";
export const CONTINUATION_V5_SUCCESSOR_FEATURE_ID =
  "P108-conversation-disclosure-evidence-foundation";
export const CONTINUATION_V5_ROUND = 5;
export const CONTINUATION_V5_REJECTED_ROUND = 4;

export const CONTINUATION_V5_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-successor-evolution-policy.json";
export const CONTINUATION_V5_BASELINE_ARCHIVE_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-baseline-archive.json";
export const CONTINUATION_V5_REVIEW_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-review-snapshot.json";
export const CONTINUATION_V5_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-closure-manifest.json";
export const CONTINUATION_V5_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-external-attestation.json";
export const CONTINUATION_V5_ROUND4_REVIEW_REJECTION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round4-review-rejection.json";

export const CONTINUATION_V5_ROUND4_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round4-successor-evolution-policy.json";
export const CONTINUATION_V5_ROUND4_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round4-review-snapshot.json";
export const CONTINUATION_V5_ROUND4_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round4-closure-manifest.json";
export const CONTINUATION_V5_ROUND4_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round4-external-attestation.json";

export const CONTINUATION_V5_REVIEW_LANES = Object.freeze([
  "contract", "runtime", "governance",
]);
export const CONTINUATION_V5_LIFECYCLE_PHASES = Object.freeze([
  "rejection_recorded",
  "policy_draft",
  "policy_published",
...
export const CONTINUATION_V5_LIFECYCLE_PROFILE_PHASES = Object.freeze([
  "review_pre_transition",
  "review_post_transition",
  "anchored_planned",
  "authorized_active",
]);
export const CONTINUATION_V5_EXECUTABLE_KINDS = Object.freeze([
  "checker", "contract", "freezer", "governance", "runner",
]);
export const CONTINUATION_V5_ADMISSION_CLASSES = Object.freeze([
  "frozen_file",
  "transition_live",
  "transition_payload",
  "post_review_mutable",
...
export const CONTINUATION_V5_ADMISSION_CLASS_SET_DIGEST =
  hashCanonicalV3(CONTINUATION_V5_ADMISSION_CLASSES);
export const CONTINUATION_V5_EXECUTABLE_PATH_BY_KIND = Object.freeze({
  checker: "scripts/check-conversation-disclosure-continuation-v5.mjs",
  contract: "scripts/conversation-disclosure-continuation-contract-v5.mjs",
  freezer: "scripts/freeze-conversation-disclosure-continuation-v5.mjs",
  governance: "scripts/conversation-disclosure-program-governance-v5.mjs",
  runner: "scripts/verify-conversation-disclosure-continuation-v5.mjs",
});
export const CONTINUATION_V5_GOVERNANCE_TRANSITIONS = Object.freeze({
...
export const CONTINUATION_V5_TARGET_PATH_BY_LIVE_PATH = Object.freeze({
  "package.json":
    ".zerox/verification/conversation-disclosure/CD03A-round5-package.target.json",
  "scripts/check-harness-state.mjs":
    ".zerox/verification/conversation-disclosure/CD03A-round5-harness.target.mjs",
  "src/shared/conversationDisclosureProgram.test.ts":
    ".zerox/verification/conversation-disclosure/CD03A-round5-program-test.target.ts",
  "src/shared/packageScripts.test.ts":
    ".zerox/verification/conversation-disclosure/CD03A-round5-package-scripts-test.target.ts",
});
export const CONTINUATION_V5_GOVERNANCE_TRANSITION_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    path: "package.json",
    kind: CONTINUATION_V5_GOVERNANCE_TRANSITIONS["package.json"],
    fromSha256:
      "sha256:560fb3e3b2829a32b4ac694c7781fce9e53941a9e20fc4ec1c08602d53c278b9",
    stagedTargetPath: CONTINUATION_V5_TARGET_PATH_BY_LIVE_PATH["package.json"],
    toSha256:
      "sha256:68755273bc7c7f9d75307da282289f2e8c341b955c2b73dc6273c55dcc3159fa",
  }),
  Object.freeze({
    path: "scripts/check-harness-state.mjs",
    kind: CONTINUATION_V5_GOVERNANCE_TRANSITIONS["scripts/check-harness-state.mjs"],
    fromSha256:
      "sha256:231d28280f6891f50f5c714b4161d1b9d93cf171e0b67396de67ce7a36e06339",
    stagedTargetPath:
      CONTINUATION_V5_TARGET_PATH_BY_LIVE_PATH["scripts/check-harness-state.mjs"],
    toSha256:
      "sha256:e254c4e5f923ffa9bb2d283d183c27a8954f02b9ec01d0beb991583a3b67b182",
  }),
  Object.freeze({
    path: "src/shared/conversationDisclosureProgram.test.ts",
    kind: CONTINUATION_V5_GOVERNANCE_TRANSITIONS[
      "src/shared/conversationDisclosureProgram.test.ts"
    ],
    fromSha256:
      "sha256:087cff0ba7f208464bf62e41f3a10dfbb88f3f2461d46398187c0b4cfa16dd5c",
    stagedTargetPath:
      CONTINUATION_V5_TARGET_PATH_BY_LIVE_PATH[
        "src/shared/conversationDisclosureProgram.test.ts"
      ],
    toSha256:
      "sha256:2cbb19577caa02269367d08330487f2e851bf6f275dffbaf757b8d43bcf56fd5",
  }),
  Object.freeze({
    ...
    stagedTargetPath:
      CONTINUATION_V5_TARGET_PATH_BY_LIVE_PATH["src/shared/packageScripts.test.ts"],
    toSha256:
      "sha256:399467de728624ac242cde5a1471b83377138506b89d1bbd4f4937d67c46ba00",
  }),
]);
export const CONTINUATION_V5_CALLER_DISPATCH_ASSURANCE =
  "caller-attested-not-signed";
export const CONTINUATION_V5_IDENTITY_ASSURANCE = "not-signed";
export const CONTINUATION_V5_INDEPENDENCE_CLAIM =
  "caller-attested-distinct-review-contexts";
export const CONTINUATION_V5_CANDIDATE_RESULT_KINDS = Object.freeze([
  "checker",
  "harness",
]);
export const CONTINUATION_V5_CANDIDATE_PATH_BY_KIND = Object.freeze({
  checker: CONTINUATION_V5_EXECUTABLE_PATH_BY_KIND.checker,
  harness: "scripts/check-harness-state.mjs",
});

export const CONTINUATION_V5_ROUND4_POLICY_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V5_ROUND4_POLICY_PATH,
  byteSha256: "sha256:f920a1f17b28b7ed63f0196f3447fbb87641fe6198e8059623f43bc4f68fb303",
  canonicalDigest: "sha256:c4b40e8dd31554b3bd25ccf1c1d3d1671291e8f52c41286d9cd729ebb8fa4843",
});
export const CONTINUATION_V5_ROUND4_SNAPSHOT_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V5_ROUND4_SNAPSHOT_PATH,
  byteSha256: "sha256:0b1625d7646eb40e3c9c9091ad85cb1e0bfab3ab3e6ebc25793d86c179a3a8c3",
  canonicalDigest: "sha256:7e3f075ac63abd39ce9e4a9ab6a3780e864c5397ddb40ecaef0d3a541febf740",
  frozenFileCount: 90,
  transitionPayloadFileCount: 4,
  baselineFileCount: 12,
});

export const CONTINUATION_V5_ROUND4_RECEIPT_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    lane: "governance",
    path: ".zerox/verification/conversation-disclosure/CD03A-round4-governance-review.json",
    byteSha256: "sha256:e9f632a950128048c30f4809ffab050c7db832cd76809ca5bdd249034b7e950e",
    canonicalDigest: "sha256:c09c4c3140545e4acfd8e7e2827b0f98b77304c97e3f4d87501b826373458a9d",
    challenge: "sha256:3fae6214ea0b5f1b8d0ed4fb4c504925ba8e445ae2c36f3da1c7634b9fd08e9d",
    verdict: "failed",
    findingCounts: Object.freeze({ critical: 0, major: 1, minor: 0 }),
  }),
]);

export const CONTINUATION_V5_ROUND4_FINDING_IDS = Object.freeze([
  "R4-GOV-001",
]);
export const CONTINUATION_V5_ROUND4_FINDING_SET_DIGEST =
  "sha256:e0176105147f2c0c33071986a167044d9d394459be7b26a8606f126b3fcb61ac";
export const CONTINUATION_V5_ROUND4_AGGREGATE_FINDING_COUNTS = Object.freeze({
  critical: 0,
  major: 1,
  minor: 0,
});
export const CONTINUATION_V5_ROUND1_REJECTION_DIGEST =
  "sha256:ec981e92f486ae75a56b3b4b393f95d095f6d684e6af54fe12cc7a9ba0fe1f99";
export const CONTINUATION_V5_ROUND2_REJECTION_TRUST_ROOT = Object.freeze({
...
export const CONTINUATION_V5_ROUND4_REPOSITORY_FORBIDDEN_OUTPUT_PATHS =
  Object.freeze([
    ...
    CONTINUATION_V5_ROUND4_CLOSURE_MANIFEST_PATH,
    CONTINUATION_V5_ROUND4_EXTERNAL_ATTESTATION_PATH,
  ].sort());
export const CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS = Object.freeze([
  ...CONTINUATION_V4_REJECTED_OUTPUT_ABSENT_PATHS,
  ...CONTINUATION_V5_ROUND4_REPOSITORY_FORBIDDEN_OUTPUT_PATHS,
].sort());
export const CONTINUATION_V5_REVIEW_OUTPUT_PATHS = Object.freeze([
  CONTINUATION_V5_REVIEW_SNAPSHOT_PATH,
  ...CONTINUATION_V5_REVIEW_LANES.map((lane) =>
...
export const CONTINUATION_V5_RUNTIME_IO_INTERFACE = Object.freeze({
  schemaVersion: 1,
...
const ROUND4_REJECTION_KEYS = Object.freeze([
...
export const CONTINUATION_V5_POLICY_KEYS = POLICY_KEYS;
export const CONTINUATION_V5_SNAPSHOT_KEYS = SNAPSHOT_KEYS;
export const CONTINUATION_V5_BASELINE_ARCHIVE_KEYS = ARCHIVE_KEYS;
export const CONTINUATION_V5_REVIEW_REJECTION_KEYS = ROUND4_REJECTION_KEYS;
export const CONTINUATION_V5_RECEIPT_KEYS = RECEIPT_KEYS;
export const CONTINUATION_V5_MANIFEST_KEYS = MANIFEST_KEYS;

export const canonicalJsonV5 = canonicalJsonV3;
export const hashCanonicalV5 = hashCanonicalV3;
export const sha256BytesV5 = sha256BytesV3;
export const sha256DigestV5 = sha256DigestV3;
export const repositoryPathV5 = repositoryPathV3;
export const withCanonicalDigestV5 = withCanonicalDigestV3;
export const stableFeatureDefinitionV5 = stableFeatureDefinitionV3;
export const stableHistoricalFeatureDefinitionV5 =
  stableHistoricalFeatureDefinitionV3;
export const stableProgramRootDefinitionV5 = stableProgramRootDefinitionV3;
export const stableWorkstreamDefinitionV5 = stableWorkstreamDefinitionV3;

export function buildAdmissionCoverageV5(
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS,
) {
  const files = admission?.featureDefinition?.files;
  if (!Array.isArray(files) || files.length === 0
    || new Set(files).size !== files.length
    || files.some((entry) => !repositoryPathV5(entry))) {
    throw new TypeError("P107A exact V5 file roster is invalid");
  }
  if (canonicalJsonV5(rejectedOutputAbsentPaths)
    !== canonicalJsonV5(CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS)) {
    throw new TypeError("V5 rejected-output absence roster is not exact");
  }
  const byClass = new Map(CONTINUATION_V5_ADMISSION_CLASSES.map((entry) => [
    entry,
    new Set(),
  ]));
  ...
  return files.map((relativePath) => {
    const classes = CONTINUATION_V5_ADMISSION_CLASSES.filter((entry) =>
      entry !== "frozen_file" && byClass.get(entry).has(relativePath));
    if (classes.length > 1) {
      throw new TypeError(`V5 path has overlapping admission classes: ${relativePath}`);
    }
    return { path: relativePath, class: classes[0] ?? "frozen_file" };
  }).sort(comparePath);
}

export function validateAdmissionCoverageV5(
  coverage,
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS,
  ...
  for (const [index, entry] of coverage.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, COVERAGE_KEYS)
      || !repositoryPathV5(entry.path)
      || !CONTINUATION_V5_ADMISSION_CLASSES.includes(entry.class)) {
  ...
  let expected;
  try {
    expected = buildAdmissionCoverageV5(
      admission,
      transitions,
  ...
  if (expected && canonicalJsonV5(coverage) !== canonicalJsonV5(expected)) {
    errors.push("admissionCoverage differs from the exact V5 classification");
  }
  ...
  for (const requiredClass of CONTINUATION_V5_ADMISSION_CLASSES) {
...
export function validateRound4ReviewRejectionV5(witness) {
  const errors = [];
  if (!plainObject(witness) || !exactKeys(witness, ROUND4_REJECTION_KEYS)) {
    return ["Round4 review rejection must contain the exact V5 keys"];
  }
  if (witness.schemaVersion !== 5
    || witness.kind !== CONTINUATION_V5_REVIEW_REJECTION_KIND
    || witness.algorithm !== CONTINUATION_V5_ALGORITHM
    || witness.workstreamId !== CONTINUATION_V5_WORKSTREAM_ID
    || witness.featureId !== CONTINUATION_V5_FEATURE_ID
    || witness.rejectedRound !== CONTINUATION_V5_REJECTED_ROUND
    || witness.recoveryRound !== CONTINUATION_V5_ROUND
    || witness.status !== "rejected_after_review"
    || !nonEmpty(witness.programId)) {
    errors.push("Round4 review rejection identity/status is invalid");
  }
  if (!sameExactObject(witness.sourcePolicy,
    CONTINUATION_V5_ROUND4_POLICY_TRUST_ROOT, POLICY_REFERENCE_KEYS)) {
    errors.push("Round4 policy reference differs from both hard trust roots");
  }
  if (!sameExactObject(witness.sourceSnapshot,
    CONTINUATION_V5_ROUND4_SNAPSHOT_TRUST_ROOT, SNAPSHOT_REFERENCE_KEYS)) {
    errors.push("Round4 snapshot reference differs from both hard trust roots");
  }
  validateFailedReceiptReferences(witness.failedReceipts, errors);
  if (!sameExactObject(witness.aggregateFindingCounts,
    CONTINUATION_V5_ROUND4_AGGREGATE_FINDING_COUNTS, FINDING_COUNT_KEYS)) {
    errors.push("Round4 aggregate finding counts differ from the failed receipts");
  }
  if (canonicalJsonV5(witness.findingIds)
    !== canonicalJsonV5(CONTINUATION_V5_ROUND4_FINDING_IDS)
    || witness.findingSetDigest !== CONTINUATION_V5_ROUND4_FINDING_SET_DIGEST) {
    errors.push("Round4 finding set differs from the hard rejection root");
  }
  if (canonicalJsonV5(witness.repositoryForbiddenOutputs)
    !== canonicalJsonV5(CONTINUATION_V5_ROUND4_REPOSITORY_FORBIDDEN_OUTPUT_PATHS)) {
    errors.push("Round4 repository forbidden-output set is not exact");
  }
  const expectedAnchorRule = expectedRejectedRound4AnchorRuleV5();
  if (!sameExactObject(witness.externalAnchorRule, expectedAnchorRule,
    EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("Round4 external anchor rule is invalid or asserts fictional absence");
  }
  const expectedPrior = {
    round1CanonicalDigest: CONTINUATION_V5_ROUND1_REJECTION_DIGEST,
    round2: CONTINUATION_V5_ROUND2_REJECTION_TRUST_ROOT,
  };
  if (!plainObject(witness.priorRejections)
    ...
    errors.push("Round4 rejection does not bind the exact prior rejection chain");
  }
  validateCanonicalDigest(witness, "Round4 review rejection", errors);
  return unique(errors);
}

export function expectedRejectedRound4AnchorRuleV5() {
  return {
    policyDigest: CONTINUATION_V5_ROUND4_POLICY_TRUST_ROOT.canonicalDigest,
    snapshotDigest: CONTINUATION_V5_ROUND4_SNAPSHOT_TRUST_ROOT.canonicalDigest,
    admissibility: "forbidden",
    externalAbsenceClaim: "not_asserted",
  };
}

export function validateRejectedRound4AnchorSubjectV5(anchor) {
  if (!plainObject(anchor)) return ["external anchor candidate must be an object"];
  if (anchor.policyDigest === CONTINUATION_V5_ROUND4_POLICY_TRUST_ROOT.canonicalDigest
    && anchor.snapshotDigest
      === CONTINUATION_V5_ROUND4_SNAPSHOT_TRUST_ROOT.canonicalDigest) {
    return ["external anchor is bound to the rejected Round4 subject"];
  }
  return [];
}

export function validateRejectedOutputAbsenceCapturesV5(captures) {
  const errors = [];
  if (!Array.isArray(captures)) return ["absence captures must be an array"];
  const expected = CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS.map((entry) => ({
    path: entry,
    presence: "absent",
  }));
  for (const [index, capture] of captures.entries()) {
    if (!plainObject(capture)
      ...
      || !repositoryPathV5(capture.path)
      || capture.presence !== "absent") {
      errors.push(`absence capture[${index}] is invalid`);
    }
  }
  if (canonicalJsonV5(captures) !== canonicalJsonV5(expected)) {
    errors.push("absence captures differ from the exact rejected-output roster");
  }
  return unique(errors);
}

export function validateRuntimeIoCaptureAdapterV5(adapter) {
  if (adapter === null || (typeof adapter !== "object"
    && typeof adapter !== "function")) {
    return ["runtime I/O adapter must be an object"];
  }
  return CONTINUATION_V5_RUNTIME_IO_INTERFACE.methods
    .filter((method) => typeof adapter[method] !== "function")
    .map((method) => `runtime I/O adapter misses ${method}`);
}

export function validateContinuationPolicyV5(policy, bindings = {}) {
  const errors = [];
  if (!plainObject(policy) || !exactKeys(policy, POLICY_KEYS)) {
    return ["continuation policy must contain the exact V5 keys"];
  }
  if (policy.schemaVersion !== 5
    || policy.kind !== CONTINUATION_V5_POLICY_KIND
    || policy.algorithm !== CONTINUATION_V5_ALGORITHM
    || policy.policyId !== CONTINUATION_V5_POLICY_ID
    || policy.workstreamId !== CONTINUATION_V5_WORKSTREAM_ID
    || policy.featureId !== CONTINUATION_V5_FEATURE_ID
    || policy.round !== CONTINUATION_V5_ROUND
    || policy.status !== "frozen"
    || !nonEmpty(policy.programId)) {
    errors.push("continuation policy V5 identity/status is invalid");
  }
  if (canonicalJsonV5(policy.admissionClassSet)
      !== canonicalJsonV5(CONTINUATION_V5_ADMISSION_CLASSES)
  ...
  errors.push(...validateRound4ReviewRejectionV5(policy.round4ReviewRejection));
  errors.push(...validateAdmissionDefinitionV2(policy.admission));
  errors.push(...validateAdmissionCoverageV5(
  ...
  if (canonicalJsonV5(policy.governanceTransitions)
    !== canonicalJsonV5(CONTINUATION_V5_GOVERNANCE_TRANSITION_TRUST_ROOTS)) {
    errors.push("V5 governance transitions differ from the Round5 target trust root");
  }
  ...
  if (!sameExactObject(policy.externalAnchorPolicy,
    expectedRejectedRound4AnchorRuleV5(), EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("policy externalAnchorPolicy does not forbid the rejected Round4 subject");
  }
  if (!plainObject(policy.reviewSnapshot)
    || !exactKeys(policy.reviewSnapshot, ["path"])
    || policy.reviewSnapshot.path !== CONTINUATION_V5_REVIEW_SNAPSHOT_PATH) {
    errors.push("policy reviewSnapshot path is invalid");
  }
  validateBaselineArchiveReferenceV5(
  ...
  if (canonicalJsonV5(rejectedCoverage)
    !== canonicalJsonV5(CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS)) {
  ...
  if (bindings.expectedAdmissionRoots !== undefined) {
    ...
    if (!plainObject(roots)
      ...
      for (const [key, actual] of [
        ...
        if (!sha256DigestV5(roots[key]) || roots[key] !== actual) {
  ...
  if (bindings.baselineArchive !== undefined) {
    errors.push(...validateBaselineArchiveV5(bindings.baselineArchive, policy));
  }
  if (bindings.lifecycleState !== undefined) {
    errors.push(...validateLifecycleStateV5(bindings.lifecycleState, policy));
  }
  return unique(errors);
}

export function validateBaselineArchiveV5(archive, policy) {
  const errors = [];
  if (!plainObject(archive) || !exactKeys(archive, ARCHIVE_KEYS)) {
    return ["baseline archive must contain the exact V5 keys"];
  }
  if (archive.schemaVersion !== 5
    || archive.kind !== CONTINUATION_V5_BASELINE_ARCHIVE_KIND
    || archive.algorithm !== CONTINUATION_V5_ALGORITHM
    || archive.workstreamId !== CONTINUATION_V5_WORKSTREAM_ID
    || archive.featureId !== CONTINUATION_V5_FEATURE_ID
    || archive.round !== CONTINUATION_V5_ROUND
    || !nonEmpty(archive.programId)) {
    errors.push("baseline archive V5 identity is invalid");
  }
  ...
  for (const [index, entry] of (archive.entries ?? []).entries()) {
    ...
    try {
      ...
      if (sha256BytesV5(decoded) !== entry.sha256) throw new Error("digest");
    } catch {
  ...
  if (plainObject(policy)) {
    ...
    if (canonicalJsonV5(actual) !== canonicalJsonV5(expected)) {
...
export function validateContinuationReviewSnapshotV5(
  snapshot,
  policy,
  bindings = {},
) {
  ...
  if (!plainObject(snapshot) || !exactKeys(snapshot, SNAPSHOT_KEYS)) {
    return ["continuation review snapshot must contain the exact V5 keys"];
  }
  if (snapshot.schemaVersion !== 5
    || snapshot.kind !== CONTINUATION_V5_SNAPSHOT_KIND
    || snapshot.algorithm !== CONTINUATION_V5_ALGORITHM
    || snapshot.workstreamId !== CONTINUATION_V5_WORKSTREAM_ID
    || snapshot.featureId !== CONTINUATION_V5_FEATURE_ID
    || snapshot.round !== CONTINUATION_V5_ROUND
    || !nonEmpty(snapshot.programId)) {
    errors.push("continuation review snapshot V5 identity is invalid");
  }
  validateTimestampV5(
    snapshot.frozenAt,
  ...
  ]) validateFileDigestArrayV5(snapshot[key], label, errors);
  validateStringPathsV5(snapshot.absentPaths, "snapshot absentPaths", errors);
  validateStringPathsV5(
  ...
  if (plainObject(policy)) {
    ...
    if (canonicalJsonV5(snapshot.governanceTransitions)
      !== canonicalJsonV5(policy.governanceTransitions)) {
      errors.push("snapshot governance transitions differ from policy");
    }
    if (canonicalJsonV5(snapshot.baselineArchive)
      !== canonicalJsonV5(policy.baselineArchive)) {
      errors.push("snapshot baselineArchive differs from policy");
    }
    validateSnapshotAdmissionSubjectsV5(snapshot, policy, errors);
    validateSnapshotAuthoritySubjectsV5(snapshot, policy, errors);
  }
  validateCanonicalDigest(snapshot, "continuation review snapshot", errors);
  return unique(errors);
}

export function validateGovernanceTransitionStateV5(
  transitions,
  phase,
  liveDigests,
  stagedDigests,
  ...
  if (canonicalJsonV5(pathKinds)
    !== canonicalJsonV5(CONTINUATION_V5_GOVERNANCE_TRANSITIONS)) {
    errors.push("V5 governance transition path/kind set is not exact");
  }
...
export function validateLifecycleStateV5(live, policy) {
  return validateLifecycleStateV2(live, policy);
}

export function selectLifecycleProfileV5(policy, phase) {
  if (!CONTINUATION_V5_LIFECYCLE_PROFILE_PHASES.includes(phase)) {
    return undefined;
  }
...
export function validateContinuationReviewReceiptV5(
  receipt,
  snapshot,
  policy,
  bindings = {},
  ...
  if (!plainObject(receipt) || !exactKeys(receipt, RECEIPT_KEYS)) {
    return ["continuation review receipt must contain the exact V5 keys"];
  }
  if (receipt.schemaVersion !== 5
    || receipt.kind !== CONTINUATION_V5_RECEIPT_KIND
    || receipt.workstreamId !== CONTINUATION_V5_WORKSTREAM_ID
    || receipt.featureId !== CONTINUATION_V5_FEATURE_ID
    || receipt.round !== CONTINUATION_V5_ROUND
    || !CONTINUATION_V5_REVIEW_LANES.includes(receipt.lane)
    || receipt.reviewedPhase !== "review_pre_transition"
    || receipt.identityAssurance !== CONTINUATION_V5_IDENTITY_ASSURANCE
    || receipt.independenceClaim !== CONTINUATION_V5_INDEPENDENCE_CLAIM
    || !nonEmpty(receipt.programId)) {
    errors.push("continuation review receipt V5 identity/assurance is invalid");
  }
  ...
  for (const key of [
    ...
    if (!sha256DigestV5(receipt[key])) errors.push(`receipt ${key} must be SHA-256`);
  }
...
export function validateContinuationReviewSetV5(
  receipts,
  callerDispatchSet,
  snapshot,
  policy,
  ...
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V5_REVIEW_LANES.length
    || !Array.isArray(callerDispatchSet)
    || callerDispatchSet.length !== CONTINUATION_V5_REVIEW_LANES.length) {
    return ["V5 review set requires exactly three receipts and dispatch-set entries"];
  }
  const contextIds = [];
  const dispatchSetDigest = hashCanonicalV5(callerDispatchSet);
  for (let index = 0; index < CONTINUATION_V5_REVIEW_LANES.length; index += 1) {
    const lane = CONTINUATION_V5_REVIEW_LANES[index];
    const receipt = receipts[index];
    const caller = callerDispatchSet[index];
    if (!plainObject(caller) || !exactKeys(caller, DISPATCH_SET_ENTRY_KEYS)
      || caller.lane !== lane
      || caller.assurance !== CONTINUATION_V5_CALLER_DISPATCH_ASSURANCE
      || caller.transport !== "codex-collaboration"
      || !sha256DigestV5(caller.challenge)
      || !sha256DigestV5(caller.instructionDigest)
    ...
    errors.push(...validateContinuationReviewReceiptV5(receipt, snapshot, policy, {
      callerPin: {
        challenge: caller.challenge,
        dispatchEntryDigest: hashCanonicalV5(caller),
        dispatchSetDigest,
      },
    }));
  ...
  if (new Set(contextIds).size !== CONTINUATION_V5_REVIEW_LANES.length) {
    errors.push("caller must attest three distinct reviewContextId values");
  }
  return unique(errors);
}

export function validateContinuationClosureManifestV5(manifest, bindings = {}) {
  const errors = [];
  if (!plainObject(manifest) || !exactKeys(manifest, MANIFEST_KEYS)) {
    return ["continuation closure manifest must contain the exact V5 keys"];
  }
  if (manifest.schemaVersion !== 5
    || manifest.kind !== CONTINUATION_V5_MANIFEST_KIND
    || manifest.workstreamId !== CONTINUATION_V5_WORKSTREAM_ID
    || manifest.featureId !== CONTINUATION_V5_FEATURE_ID
    || manifest.round !== CONTINUATION_V5_ROUND
    || !["review_passed_pending_external_transaction", "externally_attested"]
      .includes(manifest.status)) {
    errors.push("continuation closure manifest V5 identity/status is invalid");
  }
  validatePathDigest(manifest.policy, "manifest policy", errors);
  validatePathDigest(manifest.snapshot, "manifest snapshot", errors);
  validatePathDigest(manifest.round4ReviewRejection,
    "manifest Round4 rejection", errors);
  ...
  if (!sha256DigestV5(manifest.parentEvidenceBundleDigest)
    || !sha256DigestV5(manifest.pendingManifestDigest)) {
    errors.push("manifest parent/pending digest is invalid");
  }
  if (manifest.pendingManifestDigest !== pendingManifestDigestV5(manifest)) {
  ...
  if (!plainObject(manifest.externalAttestation)
    ...
    || !repositoryPathV5(manifest.externalAttestation.path)
    || (manifest.status === "review_passed_pending_external_transaction"
      ? manifest.externalAttestation.canonicalDigest !== null
      : !sha256DigestV5(manifest.externalAttestation.canonicalDigest))) {
  ...
  if (plainObject(bindings.policy)
    && (manifest.policy?.canonicalDigest !== bindings.policy.digest
      || manifest.round4ReviewRejection?.canonicalDigest
        !== bindings.policy.round4ReviewRejection?.digest)) {
  ...
  if (manifest.status === "externally_attested") {
    if (!plainObject(bindings.pendingManifest)
      ...
      || canonicalJsonV5(finalManifestProjectionV5(
        bindings.pendingManifest,
        bindings.externalAttestation.digest,
      )) !== canonicalJsonV5(withoutDigestV5(manifest))) {
...
export function pendingManifestDigestV5(manifest) {
...
export function finalManifestProjectionV5(pendingManifest, attestationDigest) {
  const projected = withoutDigestV5(pendingManifest);
...
export function validateContinuationExternalAttestationV5(
  attestation,
  bindings = {},
) {
  const errors = [];
  if (!plainObject(attestation) || !exactKeys(attestation, ATTESTATION_KEYS)) {
    return ["external attestation must contain the exact V5 keys"];
  }
  if (attestation.schemaVersion !== 5
    || attestation.kind !== CONTINUATION_V5_ATTESTATION_KIND
    || attestation.status !== "passed"
    || attestation.governancePhase !== "review_post_transition"
    || attestation.identityAssurance !== CONTINUATION_V5_IDENTITY_ASSURANCE
    || attestation.reviewAssurance !== CONTINUATION_V5_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(attestation.repositoryRealpath)) {
    errors.push("external attestation V5 identity/assurance is invalid");
  }
  for (const key of [
    "parentEvidenceBundleDigest", "pendingManifestDigest", "policyDigest",
    "round4ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV5(attestation[key])) errors.push(`attestation ${key} is invalid`);
  errors.push(...validateCallerDispatchSetShape(attestation.callerDispatchSet));
  validateCandidateResultsV5(
    attestation.candidateResults,
    bindings.policy,
    errors,
  );
  const completedAt = validateTimestampV5(
  ...
  if (!plainObject(bindings.policy)
    ...
    || !plainObject(bindings.round4ReviewRejection)
    ...
    const expected = {
      ...
      round4ReviewRejectionDigest: bindings.round4ReviewRejection.digest,
    ...
    if (canonicalJsonV5(attestation.callerDispatchSet)
      !== canonicalJsonV5(bindings.callerDispatchSet)) {
      errors.push("external attestation dispatch binding is stale");
    }
    if (Array.isArray(bindings.candidateResults)
      && canonicalJsonV5(attestation.candidateResults)
        !== canonicalJsonV5(bindings.candidateResults)) {
...
export function validateContinuationExternalAnchorV5(anchor, bindings = {}) {
  const errors = [];
  if (!plainObject(anchor) || !exactKeys(anchor, ANCHOR_KEYS)) {
    return ["external anchor must contain the exact V5 keys"];
  }
  if (anchor.schemaVersion !== 5
    || anchor.kind !== CONTINUATION_V5_ANCHOR_KIND
    || anchor.identityAssurance !== CONTINUATION_V5_IDENTITY_ASSURANCE
    || anchor.reviewAssurance !== CONTINUATION_V5_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(anchor.repositoryRealpath)) {
    errors.push("external anchor V5 identity/assurance is invalid");
  }
  for (const key of [
    "attestationDigest", "parentEvidenceBundleDigest", "policyDigest",
    "round4ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV5(anchor[key])) errors.push(`anchor ${key} is invalid`);
  ...
  if (!plainObject(bindings.attestation)
    ...
    if (canonicalJsonV5(anchor.callerDispatchSet)
      !== canonicalJsonV5(bindings.callerDispatchSet)) {
    ...
    if (canonicalJsonV5(anchor.head) !== canonicalJsonV5(expectedHead)) {
      errors.push("external anchor head is not the exact P107A successor-admission head");
    }
  }
  errors.push(...validateRejectedRound4AnchorSubjectV5(anchor));
...
export function serializeRound4ReviewRejectionV5(witness) {
  const errors = validateRound4ReviewRejectionV5(witness);
  if (errors.length > 0) throw new TypeError(errors.join("; "));
  return Buffer.from(`${JSON.stringify(witness, null, 2)}\n`, "utf8");
}

function validateCandidateResultsV5(results, policy, errors) {
  if (!Array.isArray(results)
    || results.length !== CONTINUATION_V5_CANDIDATE_RESULT_KINDS.length) {
  ...
  const expectedPaths = {
    ...CONTINUATION_V5_CANDIDATE_PATH_BY_KIND,
    checker: policyCheckerPath
      ?? CONTINUATION_V5_CANDIDATE_PATH_BY_KIND.checker,
  };
  for (let index = 0;
    index < CONTINUATION_V5_CANDIDATE_RESULT_KINDS.length;
    index += 1) {
    const result = results[index];
    const kind = CONTINUATION_V5_CANDIDATE_RESULT_KINDS[index];
    if (!plainObject(result)
      || !exactKeys(result, CANDIDATE_RESULT_KEYS)
      || result.kind !== kind
      || result.path !== expectedPaths[kind]
      || result.status !== "passed"
      || !sha256DigestV5(result.receiptDigest)
      || !sha256DigestV5(result.stdoutDigest)
      || !sha256DigestV5(result.stderrDigest)) {
      errors.push(`attestation candidateResults[${index}] is not exact ${kind} PASS evidence`);
    }
  }
}

function withoutDigestV5(value) {
  const projected = structuredClone(value);
  delete projected.digest;
  return projected;
}

function validateSnapshotAdmissionSubjectsV5(snapshot, policy, errors) {
  const byClass = new Map(
    CONTINUATION_V5_ADMISSION_CLASSES.map((value) => [value, []]),
  );
  ...
  for (const reference of [
    ...
    if (frozen.get(reference.path) !== reference.byteSha256) {
      errors.push(`snapshot does not freeze Round4 rejection evidence: ${reference.path}`);
    }
  }
  const rejectionBytes = sha256BytesV5(
    serializeRound4ReviewRejectionV5(policy.round4ReviewRejection),
  );
  if (frozen.get(CONTINUATION_V5_ROUND4_REVIEW_REJECTION_PATH)
    !== rejectionBytes) {
    errors.push("snapshot does not freeze exact Round4 review-rejection bytes");
  }
}

function validateSnapshotAuthoritySubjectsV5(snapshot, policy, errors) {
  const baseline = new Map((snapshot.baselineFiles ?? [])
    .map((entry) => [entry.path, entry.sha256]));
  const absent = new Set(snapshot.absentPaths ?? []);
  const expectedBaseline = new Map();
  const expectedAbsent = new Set(CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS);
  for (const authority of policy.pathAuthorities ?? []) {
    if (authority.class === "modify"
  ...
  if (!sameMap(baseline, expectedBaseline)) {
    errors.push("snapshot baselineFiles do not exactly bind V5 baselines");
  }
...
function validateBaselineArchiveReferenceV5(reference, subject, errors) {
  if (!plainObject(reference)
    || !exactKeys(reference, ["digest", "entrySetDigest", "path"])
    || reference.path !== CONTINUATION_V5_BASELINE_ARCHIVE_PATH
    || !sha256DigestV5(reference.digest)
    || !sha256DigestV5(reference.entrySetDigest)) {
    errors.push(`${subject} is invalid`);
  }
}

function validateFileDigestArrayV5(entries, subject, errors) {
  ...
  for (const [index, entry] of entries.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, FILE_DIGEST_KEYS)
      || !repositoryPathV5(entry.path) || !sha256DigestV5(entry.sha256)) {
...
function validateStringPathsV5(entries, subject, errors) {
  if (!Array.isArray(entries)) {
    errors.push(`${subject} must be an array`);
    return;
  }
  if (entries.some((entry) => !repositoryPathV5(entry))) {
    errors.push(`${subject} contains an invalid path`);
  }
  validateSortedUnique(entries, subject, errors);
}

function validateTimestampV5(value, verifierNow, subject, errors) {
...
function validateFailedReceiptReferences(receipts, errors) {
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V5_ROUND4_RECEIPT_TRUST_ROOTS.length) {
    errors.push("Round4 rejection must bind exactly the governance failed receipt");
    return;
  }
  for (let index = 0; index < receipts.length; index += 1) {
    ...
    if (!plainObject(actual) || !exactKeys(actual, FAILED_RECEIPT_REFERENCE_KEYS)
      ...
      || !sameExactObject(actual.findingCounts, expected.findingCounts,
        FINDING_COUNT_KEYS)) {
      errors.push(`Round4 failed receipt root differs for lane ${expected.lane}`);
    }
  }
}
...
function validateReviewAssurancePolicy(value, errors) {
  ...
  if (!plainObject(value) || !exactKeys(value, keys)
    || value.callerDispatchAssurance !== CONTINUATION_V5_CALLER_DISPATCH_ASSURANCE
    || value.identityAssurance !== CONTINUATION_V5_IDENTITY_ASSURANCE
    || value.independenceClaim !== CONTINUATION_V5_INDEPENDENCE_CLAIM
...
function validateExecutableRoots(policy, errors) {
  if (!Array.isArray(policy.continuationExecutables)
    || canonicalJsonV5(policy.continuationExecutables.map((entry) => entry?.kind))
      !== canonicalJsonV5(CONTINUATION_V5_EXECUTABLE_KINDS)) {
    errors.push("continuationExecutables must contain the exact ordered V5 kinds");
    return;
  }
  for (const [index, entry] of policy.continuationExecutables.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, ["kind", "path", "sha256"])
      || entry.path !== CONTINUATION_V5_EXECUTABLE_PATH_BY_KIND[entry.kind]
      || !repositoryPathV5(entry.path) || !sha256DigestV5(entry.sha256)) {
  ...
  if (canonicalJsonV5(actualSubset) !== canonicalJsonV5(expectedTrustRoots)) {
    errors.push("trustRoots do not bind every V5 transition and executable byte");
  }
}
...
function validateCallerDispatchSetShape(entries) {
  const errors = [];
  if (!Array.isArray(entries)
    || entries.length !== CONTINUATION_V5_REVIEW_LANES.length) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, DISPATCH_SET_ENTRY_KEYS)
      || entry.lane !== CONTINUATION_V5_REVIEW_LANES[index]
      || entry.assurance !== CONTINUATION_V5_CALLER_DISPATCH_ASSURANCE
      || entry.transport !== "codex-collaboration"
      || !sha256DigestV5(entry.challenge)
      || !sha256DigestV5(entry.instructionDigest)
...
function validateReviewReferences(entries, errors) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, REVIEW_REFERENCE_KEYS)
      ...
      || !repositoryPathV5(entry.path)
      || !sha256DigestV5(entry.challenge)
      || !sha256DigestV5(entry.canonicalDigest)) {
...
function validateFindings(receipt, errors) {
  ...
  if (canonicalJsonV5(actual) !== canonicalJsonV5(receipt.findingCounts)) {
...
function validatePathDigest(value, label, errors) {
  if (!plainObject(value)
    ...
    || !repositoryPathV5(value.path)
    || !sha256DigestV5(value.byteSha256)
    || !sha256DigestV5(value.canonicalDigest)) {
...
function validatePathSha(value, label, errors) {
  if (!plainObject(value) || !exactKeys(value, ["path", "sha256"])
    || !repositoryPathV5(value.path) || !sha256DigestV5(value.sha256)) {
    errors.push(`${label} is invalid`);
  }
}

function validateCanonicalDigest(value, label, errors) {
  if (!sha256DigestV5(value?.digest)) {
    errors.push(`${label} digest must be SHA-256`);
    return;
  }
  const withoutDigest = { ...value };
  delete withoutDigest.digest;
  if (hashCanonicalV5(withoutDigest) !== value.digest) {
...
function sameExactObject(actual, expected, keys) {
  return plainObject(actual)
    ...
    && canonicalJsonV5(actual) === canonicalJsonV5(expected);
}

function exactKeys(value, expected) {
  if (!plainObject(value)) return false;
  return canonicalJsonV5(Object.keys(value).sort())
    === canonicalJsonV5([...expected].sort());
}
...
function validateSortedUnique(values, label, errors) {
  ...
  if (new Set(values).size !== values.length
    || canonicalJsonV5(values) !== canonicalJsonV5(sorted)) {
    errors.push(`${label} must be sorted and unique`);
  }
}

function sameStringSet(left, right) {
  return canonicalJsonV5([...new Set(left)].sort())
    === canonicalJsonV5([...new Set(right)].sort());
}

function sameMap(left, right) {
  const project = (value) =>
    [...value.entries()].sort(([a], [b]) => a.localeCompare(b));
  return canonicalJsonV5(project(left)) === canonicalJsonV5(project(right));
}
...
export const canonicalJson = canonicalJsonV5;
export const hashCanonical = hashCanonicalV5;
export const sha256Bytes = sha256BytesV5;
export const validateRound4ReviewRejection = validateRound4ReviewRejectionV5;
export const validateAdmissionCoverage = validateAdmissionCoverageV5;
export const validateContinuationPolicy = validateContinuationPolicyV5;
export const validateBaselineArchive = validateBaselineArchiveV5;
export const validateReviewSnapshotV5 = validateContinuationReviewSnapshotV5;
export const validateReviewSnapshot = validateContinuationReviewSnapshotV5;
export const validateReviewReceiptV5 = validateContinuationReviewReceiptV5;
export const validateReviewSetV5 = validateContinuationReviewSetV5;
export const validateClosureManifestV5 = validateContinuationClosureManifestV5;
export const validateExternalAttestationV5 =
  validateContinuationExternalAttestationV5;
export const validateExternalAnchorV5 = validateContinuationExternalAnchorV5;
