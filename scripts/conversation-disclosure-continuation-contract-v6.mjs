...
export const CONTINUATION_V6_ALGORITHM = "sha256-canonical-json-v1";
export const CONTINUATION_V6_POLICY_KIND =
  "conversation-disclosure-continuation-policy";
export const CONTINUATION_V6_SNAPSHOT_KIND =
  "conversation-disclosure-continuation-review-snapshot";
export const CONTINUATION_V6_RECEIPT_KIND =
  "conversation-disclosure-continuation-review-receipt";
export const CONTINUATION_V6_MANIFEST_KIND =
  "conversation-disclosure-continuation-closure-manifest";
export const CONTINUATION_V6_ATTESTATION_KIND =
  "conversation-disclosure-continuation-external-attestation";
export const CONTINUATION_V6_ANCHOR_KIND =
  "conversation-disclosure-continuation-external-anchor";
export const CONTINUATION_V6_REVIEW_REJECTION_KIND =
  "conversation-disclosure-continuation-review-rejection";
export const CONTINUATION_V6_BASELINE_ARCHIVE_KIND =
  "conversation-disclosure-continuation-baseline-archive";

export const CONTINUATION_V6_POLICY_ID = "CD03A-round6-P108-admission-v6";
export const CONTINUATION_V6_WORKSTREAM_ID = "CD03A";
export const CONTINUATION_V6_FEATURE_ID =
  "P107A-conversation-disclosure-successor-admission";
export const CONTINUATION_V6_SUCCESSOR_WORKSTREAM_ID = "CD04";
export const CONTINUATION_V6_SUCCESSOR_FEATURE_ID =
  "P108-conversation-disclosure-evidence-foundation";
export const CONTINUATION_V6_ROUND = 6;
export const CONTINUATION_V6_REJECTED_ROUND = 5;

export const CONTINUATION_V6_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round6-successor-evolution-policy.json";
export const CONTINUATION_V6_BASELINE_ARCHIVE_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round6-baseline-archive.json";
export const CONTINUATION_V6_REVIEW_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round6-review-snapshot.json";
export const CONTINUATION_V6_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round6-closure-manifest.json";
export const CONTINUATION_V6_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round6-external-attestation.json";
export const CONTINUATION_V6_ROUND5_REVIEW_REJECTION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-review-rejection.json";

export const CONTINUATION_V6_ROUND5_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-successor-evolution-policy.json";
export const CONTINUATION_V6_ROUND5_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-review-snapshot.json";
export const CONTINUATION_V6_ROUND5_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-closure-manifest.json";
export const CONTINUATION_V6_ROUND5_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round5-external-attestation.json";

export const CONTINUATION_V6_REVIEW_LANES = Object.freeze([
  "contract", "runtime", "governance",
]);
export const CONTINUATION_V6_LIFECYCLE_PHASES = Object.freeze([
  "rejection_recorded",
  "policy_draft",
  "policy_published",
...
export const CONTINUATION_V6_LIFECYCLE_PROFILE_PHASES = Object.freeze([
  "review_pre_transition",
  "review_post_transition",
  "anchored_planned",
  "authorized_active",
]);
export const CONTINUATION_V6_EXECUTABLE_KINDS = Object.freeze([
  "checker", "contract", "freezer", "governance", "runner",
]);
export const CONTINUATION_V6_ADMISSION_CLASSES = Object.freeze([
  "frozen_file",
  "transition_live",
  "transition_payload",
  "post_review_mutable",
...
export const CONTINUATION_V6_ADMISSION_CLASS_SET_DIGEST =
  hashCanonicalV3(CONTINUATION_V6_ADMISSION_CLASSES);
export const CONTINUATION_V6_EXECUTABLE_PATH_BY_KIND = Object.freeze({
  checker: "scripts/check-conversation-disclosure-continuation-v6.mjs",
  contract: "scripts/conversation-disclosure-continuation-contract-v6.mjs",
  freezer: "scripts/freeze-conversation-disclosure-continuation-v6.mjs",
  governance: "scripts/conversation-disclosure-program-governance-v6.mjs",
  runner: "scripts/verify-conversation-disclosure-continuation-v6.mjs",
});
export const CONTINUATION_V6_GOVERNANCE_TRANSITIONS = Object.freeze({
...
export const CONTINUATION_V6_TARGET_PATH_BY_LIVE_PATH = Object.freeze({
  "package.json":
    ".zerox/verification/conversation-disclosure/CD03A-round6-package.target.json",
  "scripts/check-harness-state.mjs":
    ".zerox/verification/conversation-disclosure/CD03A-round6-harness.target.mjs",
  "src/shared/conversationDisclosureProgram.test.ts":
    ".zerox/verification/conversation-disclosure/CD03A-round6-program-test.target.ts",
  "src/shared/packageScripts.test.ts":
    ".zerox/verification/conversation-disclosure/CD03A-round6-package-scripts-test.target.ts",
});
export const CONTINUATION_V6_GOVERNANCE_TRANSITION_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    path: "package.json",
    kind: CONTINUATION_V6_GOVERNANCE_TRANSITIONS["package.json"],
    fromSha256:
      "sha256:560fb3e3b2829a32b4ac694c7781fce9e53941a9e20fc4ec1c08602d53c278b9",
    stagedTargetPath: CONTINUATION_V6_TARGET_PATH_BY_LIVE_PATH["package.json"],
    toSha256:
      "sha256:197a87814d5ced003c46fe90d1205c586360aca6ec1ee46b1be5f482665917c9",
  }),
  Object.freeze({
    path: "scripts/check-harness-state.mjs",
    kind: CONTINUATION_V6_GOVERNANCE_TRANSITIONS["scripts/check-harness-state.mjs"],
    fromSha256:
      "sha256:231d28280f6891f50f5c714b4161d1b9d93cf171e0b67396de67ce7a36e06339",
    stagedTargetPath:
      CONTINUATION_V6_TARGET_PATH_BY_LIVE_PATH["scripts/check-harness-state.mjs"],
    toSha256:
      "sha256:031099e1900ac781562aca75e1305fee8bcc7331390dfc805409d8b360374e81",
  }),
  Object.freeze({
    path: "src/shared/conversationDisclosureProgram.test.ts",
    kind: CONTINUATION_V6_GOVERNANCE_TRANSITIONS[
      "src/shared/conversationDisclosureProgram.test.ts"
    ],
    fromSha256:
      "sha256:087cff0ba7f208464bf62e41f3a10dfbb88f3f2461d46398187c0b4cfa16dd5c",
    stagedTargetPath:
      CONTINUATION_V6_TARGET_PATH_BY_LIVE_PATH[
        "src/shared/conversationDisclosureProgram.test.ts"
      ],
    toSha256:
      "sha256:40f79d475eb9c212e47dc033ee71dc6ade5bb3994f050194d72cf83322bb798c",
  }),
  Object.freeze({
    ...
    stagedTargetPath:
      CONTINUATION_V6_TARGET_PATH_BY_LIVE_PATH["src/shared/packageScripts.test.ts"],
    toSha256:
      "sha256:fca350684c7a48bfb7ef61488f18ea60a9809827173a391cd4f4568f00f4e411",
  }),
]);
export const CONTINUATION_V6_CALLER_DISPATCH_ASSURANCE =
  "caller-attested-not-signed";
export const CONTINUATION_V6_IDENTITY_ASSURANCE = "not-signed";
export const CONTINUATION_V6_INDEPENDENCE_CLAIM =
  "caller-attested-distinct-review-contexts";
export const CONTINUATION_V6_CANDIDATE_RESULT_KINDS = Object.freeze([
  "checker",
  "harness",
]);
export const CONTINUATION_V6_CANDIDATE_PATH_BY_KIND = Object.freeze({
  checker: CONTINUATION_V6_EXECUTABLE_PATH_BY_KIND.checker,
  harness: "scripts/check-harness-state.mjs",
});

export const CONTINUATION_V6_ROUND5_POLICY_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V6_ROUND5_POLICY_PATH,
  byteSha256: "sha256:a5c09998dbe27d5bbe3570e530235dcb74cbcb8abd472e5e68b77f30c288e63a",
  canonicalDigest: "sha256:96836e23520f240e59139aab3d54074c11a53a1ac51b59e614c4cc994bdabb6b",
});
export const CONTINUATION_V6_ROUND5_SNAPSHOT_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V6_ROUND5_SNAPSHOT_PATH,
  byteSha256: "sha256:399ec2c66cad17cf8aa72e0e7af570eaf70f07fd8fed12f0f5753964b449a67a",
  canonicalDigest: "sha256:265f8d761f26c9ea80f2fe3cd60bdf5990fa24a96b087cdac776b2dce9d926c3",
  frozenFileCount: 121,
  transitionPayloadFileCount: 4,
  baselineFileCount: 12,
});

export const CONTINUATION_V6_ROUND5_RECEIPT_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    lane: "governance",
    path: ".zerox/verification/conversation-disclosure/CD03A-round5-governance-review.json",
    byteSha256: "sha256:6da9db98e02231d768b2457eb222ed323496227cd47cc9ce4084332fba7c0c88",
    canonicalDigest: "sha256:bd7d71875ef9bcfed39fe67376eb52bfa4bd2b9900ca596db1c85375d433e91f",
    challenge: "sha256:cc46af5d4b5754ce34f94f3210792f0d0e09efc07e50831494d914e9b7dc977d",
    verdict: "failed",
    findingCounts: Object.freeze({ critical: 1, major: 2, minor: 0 }),
  }),
]);

export const CONTINUATION_V6_ROUND5_FINDING_IDS = Object.freeze([
  "R5-GOV-001",
  "R5-GOV-002",
  "R5-GOV-003",
]);
export const CONTINUATION_V6_ROUND5_FINDING_SET_DIGEST =
  "sha256:8375d6cfc0e37d16dba46e6e26684a4c80564f4068dad34c4e777ed387d25169";
export const CONTINUATION_V6_ROUND5_AGGREGATE_FINDING_COUNTS = Object.freeze({
  critical: 1,
  major: 2,
  minor: 0,
});
export const CONTINUATION_V6_ROUND1_REJECTION_DIGEST =
  "sha256:ec981e92f486ae75a56b3b4b393f95d095f6d684e6af54fe12cc7a9ba0fe1f99";
export const CONTINUATION_V6_ROUND2_REJECTION_TRUST_ROOT = Object.freeze({
...
export const CONTINUATION_V6_ROUND5_REPOSITORY_FORBIDDEN_OUTPUT_PATHS =
  Object.freeze([
    ...
    CONTINUATION_V6_ROUND5_CLOSURE_MANIFEST_PATH,
    CONTINUATION_V6_ROUND5_EXTERNAL_ATTESTATION_PATH,
  ].sort());
export const CONTINUATION_V6_REJECTED_OUTPUT_ABSENT_PATHS = Object.freeze([
  ...CONTINUATION_V5_REJECTED_OUTPUT_ABSENT_PATHS,
  ...CONTINUATION_V6_ROUND5_REPOSITORY_FORBIDDEN_OUTPUT_PATHS,
].sort());
export const CONTINUATION_V6_REVIEW_OUTPUT_PATHS = Object.freeze([
  CONTINUATION_V6_REVIEW_SNAPSHOT_PATH,
  ...CONTINUATION_V6_REVIEW_LANES.map((lane) =>
...
export const CONTINUATION_V6_RUNTIME_IO_INTERFACE = Object.freeze({
  schemaVersion: 1,
...
const ROUND5_REJECTION_KEYS = Object.freeze([
...
const FAILED_RECEIPT_REFERENCE_KEYS = Object.freeze([
...
export const CONTINUATION_V6_POLICY_KEYS = POLICY_KEYS;
export const CONTINUATION_V6_SNAPSHOT_KEYS = SNAPSHOT_KEYS;
export const CONTINUATION_V6_BASELINE_ARCHIVE_KEYS = ARCHIVE_KEYS;
export const CONTINUATION_V6_REVIEW_REJECTION_KEYS = ROUND5_REJECTION_KEYS;
export const CONTINUATION_V6_RECEIPT_KEYS = RECEIPT_KEYS;
export const CONTINUATION_V6_MANIFEST_KEYS = MANIFEST_KEYS;

export const canonicalJsonV6 = canonicalJsonV3;
export const hashCanonicalV6 = hashCanonicalV3;
export const sha256BytesV6 = sha256BytesV3;
export const sha256DigestV6 = sha256DigestV3;
export const repositoryPathV6 = repositoryPathV3;
export const withCanonicalDigestV6 = withCanonicalDigestV3;
export const stableFeatureDefinitionV6 = stableFeatureDefinitionV3;
export const stableHistoricalFeatureDefinitionV6 =
  stableHistoricalFeatureDefinitionV3;
export const stableProgramRootDefinitionV6 = stableProgramRootDefinitionV3;
export const stableWorkstreamDefinitionV6 = stableWorkstreamDefinitionV3;

export function buildAdmissionCoverageV6(
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V6_REJECTED_OUTPUT_ABSENT_PATHS,
) {
  const files = admission?.featureDefinition?.files;
  if (!Array.isArray(files) || files.length === 0
    || new Set(files).size !== files.length
    || files.some((entry) => !repositoryPathV6(entry))) {
    throw new TypeError("P107A exact V6 file roster is invalid");
  }
  if (canonicalJsonV6(rejectedOutputAbsentPaths)
    !== canonicalJsonV6(CONTINUATION_V6_REJECTED_OUTPUT_ABSENT_PATHS)) {
    throw new TypeError("V6 rejected-output absence roster is not exact");
  }
  const byClass = new Map(CONTINUATION_V6_ADMISSION_CLASSES.map((entry) => [
    entry,
    new Set(),
  ]));
  ...
  return files.map((relativePath) => {
    const classes = CONTINUATION_V6_ADMISSION_CLASSES.filter((entry) =>
      entry !== "frozen_file" && byClass.get(entry).has(relativePath));
    if (classes.length > 1) {
      throw new TypeError(`V6 path has overlapping admission classes: ${relativePath}`);
    }
    return { path: relativePath, class: classes[0] ?? "frozen_file" };
  }).sort(comparePath);
}

export function validateAdmissionCoverageV6(
  coverage,
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V6_REJECTED_OUTPUT_ABSENT_PATHS,
  ...
  for (const [index, entry] of coverage.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, COVERAGE_KEYS)
      || !repositoryPathV6(entry.path)
      || !CONTINUATION_V6_ADMISSION_CLASSES.includes(entry.class)) {
  ...
  let expected;
  try {
    expected = buildAdmissionCoverageV6(
      admission,
      transitions,
  ...
  if (expected && canonicalJsonV6(coverage) !== canonicalJsonV6(expected)) {
    errors.push("admissionCoverage differs from the exact V6 classification");
  }
  ...
  for (const requiredClass of CONTINUATION_V6_ADMISSION_CLASSES) {
...
export function validateRound5ReviewRejectionV6(witness) {
  const errors = [];
  if (!plainObject(witness) || !exactKeys(witness, ROUND5_REJECTION_KEYS)) {
    return ["Round5 review rejection must contain the exact V6 keys"];
  }
  if (witness.schemaVersion !== 6
    || witness.kind !== CONTINUATION_V6_REVIEW_REJECTION_KIND
    || witness.algorithm !== CONTINUATION_V6_ALGORITHM
    || witness.workstreamId !== CONTINUATION_V6_WORKSTREAM_ID
    || witness.featureId !== CONTINUATION_V6_FEATURE_ID
    || witness.rejectedRound !== CONTINUATION_V6_REJECTED_ROUND
    || witness.recoveryRound !== CONTINUATION_V6_ROUND
    || witness.status !== "rejected_after_review"
    || !nonEmpty(witness.programId)) {
    errors.push("Round5 review rejection identity/status is invalid");
  }
  if (!sameExactObject(witness.sourcePolicy,
    CONTINUATION_V6_ROUND5_POLICY_TRUST_ROOT, POLICY_REFERENCE_KEYS)) {
    errors.push("Round5 policy reference differs from both hard trust roots");
  }
  if (!sameExactObject(witness.sourceSnapshot,
    CONTINUATION_V6_ROUND5_SNAPSHOT_TRUST_ROOT, SNAPSHOT_REFERENCE_KEYS)) {
    errors.push("Round5 snapshot reference differs from both hard trust roots");
  }
  validateFailedReceiptReferences(witness.failedReceipts, errors);
  if (!sameExactObject(witness.aggregateFindingCounts,
    CONTINUATION_V6_ROUND5_AGGREGATE_FINDING_COUNTS, FINDING_COUNT_KEYS)) {
    errors.push("Round5 aggregate finding counts differ from the failed receipts");
  }
  if (canonicalJsonV6(witness.findingIds)
    !== canonicalJsonV6(CONTINUATION_V6_ROUND5_FINDING_IDS)
    || witness.findingSetDigest !== CONTINUATION_V6_ROUND5_FINDING_SET_DIGEST) {
    errors.push("Round5 finding set differs from the hard rejection root");
  }
  if (canonicalJsonV6(witness.repositoryForbiddenOutputs)
    !== canonicalJsonV6(CONTINUATION_V6_ROUND5_REPOSITORY_FORBIDDEN_OUTPUT_PATHS)) {
    errors.push("Round5 repository forbidden-output set is not exact");
  }
  const expectedAnchorRule = expectedRejectedRound5AnchorRuleV6();
  if (!sameExactObject(witness.externalAnchorRule, expectedAnchorRule,
    EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("Round5 external anchor rule is invalid or asserts fictional absence");
  }
  const expectedPrior = {
    round1CanonicalDigest: CONTINUATION_V6_ROUND1_REJECTION_DIGEST,
    round2: CONTINUATION_V6_ROUND2_REJECTION_TRUST_ROOT,
  };
  if (!plainObject(witness.priorRejections)
    ...
    errors.push("Round5 rejection does not bind the exact prior rejection chain");
  }
  validateCanonicalDigest(witness, "Round5 review rejection", errors);
  return unique(errors);
}

export function expectedRejectedRound5AnchorRuleV6() {
  return {
    policyDigest: CONTINUATION_V6_ROUND5_POLICY_TRUST_ROOT.canonicalDigest,
    snapshotDigest: CONTINUATION_V6_ROUND5_SNAPSHOT_TRUST_ROOT.canonicalDigest,
    admissibility: "forbidden",
    externalAbsenceClaim: "not_asserted",
  };
}

export function validateRejectedRound5AnchorSubjectV6(anchor) {
  if (!plainObject(anchor)) return ["external anchor candidate must be an object"];
  if (anchor.policyDigest === CONTINUATION_V6_ROUND5_POLICY_TRUST_ROOT.canonicalDigest
    && anchor.snapshotDigest
      === CONTINUATION_V6_ROUND5_SNAPSHOT_TRUST_ROOT.canonicalDigest) {
    return ["external anchor is bound to the rejected Round5 subject"];
  }
  return [];
}

export function validateRejectedOutputAbsenceCapturesV6(captures) {
  const errors = [];
  if (!Array.isArray(captures)) return ["absence captures must be an array"];
  const expected = CONTINUATION_V6_REJECTED_OUTPUT_ABSENT_PATHS.map((entry) => ({
    path: entry,
    presence: "absent",
  }));
  for (const [index, capture] of captures.entries()) {
    if (!plainObject(capture)
      ...
      || !repositoryPathV6(capture.path)
      || capture.presence !== "absent") {
      errors.push(`absence capture[${index}] is invalid`);
    }
  }
  if (canonicalJsonV6(captures) !== canonicalJsonV6(expected)) {
    errors.push("absence captures differ from the exact rejected-output roster");
  }
  return unique(errors);
}

export function validateRuntimeIoCaptureAdapterV6(adapter) {
  if (adapter === null || (typeof adapter !== "object"
    && typeof adapter !== "function")) {
    return ["runtime I/O adapter must be an object"];
  }
  return CONTINUATION_V6_RUNTIME_IO_INTERFACE.methods
    .filter((method) => typeof adapter[method] !== "function")
    .map((method) => `runtime I/O adapter misses ${method}`);
}

export function validateContinuationPolicyV6(policy, bindings = {}) {
  const errors = [];
  if (!plainObject(policy) || !exactKeys(policy, POLICY_KEYS)) {
    return ["continuation policy must contain the exact V6 keys"];
  }
  if (policy.schemaVersion !== 6
    || policy.kind !== CONTINUATION_V6_POLICY_KIND
    || policy.algorithm !== CONTINUATION_V6_ALGORITHM
    || policy.policyId !== CONTINUATION_V6_POLICY_ID
    || policy.workstreamId !== CONTINUATION_V6_WORKSTREAM_ID
    || policy.featureId !== CONTINUATION_V6_FEATURE_ID
    || policy.round !== CONTINUATION_V6_ROUND
    || policy.status !== "frozen"
    || !nonEmpty(policy.programId)) {
    errors.push("continuation policy V6 identity/status is invalid");
  }
  if (canonicalJsonV6(policy.admissionClassSet)
      !== canonicalJsonV6(CONTINUATION_V6_ADMISSION_CLASSES)
  ...
  errors.push(...validateRound5ReviewRejectionV6(policy.round5ReviewRejection));
  errors.push(...validateAdmissionDefinitionV2(policy.admission));
  errors.push(...validateAdmissionCoverageV6(
  ...
  if (canonicalJsonV6(policy.governanceTransitions)
    !== canonicalJsonV6(CONTINUATION_V6_GOVERNANCE_TRANSITION_TRUST_ROOTS)) {
    errors.push("V6 governance transitions differ from the Round6 target trust root");
  }
  ...
  if (!sameExactObject(policy.externalAnchorPolicy,
    expectedRejectedRound5AnchorRuleV6(), EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("policy externalAnchorPolicy does not forbid the rejected Round5 subject");
  }
  if (!plainObject(policy.reviewSnapshot)
    || !exactKeys(policy.reviewSnapshot, ["path"])
    || policy.reviewSnapshot.path !== CONTINUATION_V6_REVIEW_SNAPSHOT_PATH) {
    errors.push("policy reviewSnapshot path is invalid");
  }
  validateBaselineArchiveReferenceV6(
  ...
  if (canonicalJsonV6(rejectedCoverage)
    !== canonicalJsonV6(CONTINUATION_V6_REJECTED_OUTPUT_ABSENT_PATHS)) {
  ...
  if (bindings.expectedAdmissionRoots !== undefined) {
    ...
    if (!plainObject(roots)
      ...
      for (const [key, actual] of [
        ...
        if (!sha256DigestV6(roots[key]) || roots[key] !== actual) {
  ...
  if (bindings.baselineArchive !== undefined) {
    errors.push(...validateBaselineArchiveV6(bindings.baselineArchive, policy));
  }
  if (bindings.lifecycleState !== undefined) {
    errors.push(...validateLifecycleStateV6(bindings.lifecycleState, policy));
  }
  return unique(errors);
}

export function validateBaselineArchiveV6(archive, policy) {
  const errors = [];
  if (!plainObject(archive) || !exactKeys(archive, ARCHIVE_KEYS)) {
    return ["baseline archive must contain the exact V6 keys"];
  }
  if (archive.schemaVersion !== 6
    || archive.kind !== CONTINUATION_V6_BASELINE_ARCHIVE_KIND
    || archive.algorithm !== CONTINUATION_V6_ALGORITHM
    || archive.workstreamId !== CONTINUATION_V6_WORKSTREAM_ID
    || archive.featureId !== CONTINUATION_V6_FEATURE_ID
    || archive.round !== CONTINUATION_V6_ROUND
    || !nonEmpty(archive.programId)) {
    errors.push("baseline archive V6 identity is invalid");
  }
  ...
  for (const [index, entry] of (archive.entries ?? []).entries()) {
    ...
    try {
      ...
      if (sha256BytesV6(decoded) !== entry.sha256) throw new Error("digest");
    } catch {
  ...
  if (plainObject(policy)) {
    ...
    if (canonicalJsonV6(actual) !== canonicalJsonV6(expected)) {
...
export function validateContinuationReviewSnapshotV6(
  snapshot,
  policy,
  bindings = {},
) {
  ...
  if (!plainObject(snapshot) || !exactKeys(snapshot, SNAPSHOT_KEYS)) {
    return ["continuation review snapshot must contain the exact V6 keys"];
  }
  if (snapshot.schemaVersion !== 6
    || snapshot.kind !== CONTINUATION_V6_SNAPSHOT_KIND
    || snapshot.algorithm !== CONTINUATION_V6_ALGORITHM
    || snapshot.workstreamId !== CONTINUATION_V6_WORKSTREAM_ID
    || snapshot.featureId !== CONTINUATION_V6_FEATURE_ID
    || snapshot.round !== CONTINUATION_V6_ROUND
    || !nonEmpty(snapshot.programId)) {
    errors.push("continuation review snapshot V6 identity is invalid");
  }
  validateTimestampV6(
    snapshot.frozenAt,
  ...
  ]) validateFileDigestArrayV6(snapshot[key], label, errors);
  validateStringPathsV6(snapshot.absentPaths, "snapshot absentPaths", errors);
  validateStringPathsV6(
  ...
  if (plainObject(policy)) {
    const expectedBindings = {
      ...
      round5ReviewRejectionDigest: policy.round5ReviewRejection?.digest,
    };
    ...
    if (canonicalJsonV6(snapshot.governanceTransitions)
      !== canonicalJsonV6(policy.governanceTransitions)) {
      errors.push("snapshot governance transitions differ from policy");
    }
    if (canonicalJsonV6(snapshot.baselineArchive)
      !== canonicalJsonV6(policy.baselineArchive)) {
      errors.push("snapshot baselineArchive differs from policy");
    }
    validateSnapshotAdmissionSubjectsV6(snapshot, policy, errors);
    validateSnapshotAuthoritySubjectsV6(snapshot, policy, errors);
  }
  validateCanonicalDigest(snapshot, "continuation review snapshot", errors);
  return unique(errors);
}

export function validateGovernanceTransitionStateV6(
  transitions,
  phase,
  liveDigests,
  stagedDigests,
  ...
  if (canonicalJsonV6(pathKinds)
    !== canonicalJsonV6(CONTINUATION_V6_GOVERNANCE_TRANSITIONS)) {
    errors.push("V6 governance transition path/kind set is not exact");
  }
...
export function validateLifecycleStateV6(live, policy) {
  return validateLifecycleStateV2(live, policy);
}

export function selectLifecycleProfileV6(policy, phase) {
  if (!CONTINUATION_V6_LIFECYCLE_PROFILE_PHASES.includes(phase)) {
    return undefined;
  }
...
export function validateContinuationReviewReceiptV6(
  receipt,
  snapshot,
  policy,
  bindings = {},
  ...
  if (!plainObject(receipt) || !exactKeys(receipt, RECEIPT_KEYS)) {
    return ["continuation review receipt must contain the exact V6 keys"];
  }
  if (receipt.schemaVersion !== 6
    || receipt.kind !== CONTINUATION_V6_RECEIPT_KIND
    || receipt.workstreamId !== CONTINUATION_V6_WORKSTREAM_ID
    || receipt.featureId !== CONTINUATION_V6_FEATURE_ID
    || receipt.round !== CONTINUATION_V6_ROUND
    || !CONTINUATION_V6_REVIEW_LANES.includes(receipt.lane)
    || receipt.reviewedPhase !== "review_pre_transition"
    || receipt.identityAssurance !== CONTINUATION_V6_IDENTITY_ASSURANCE
    || receipt.independenceClaim !== CONTINUATION_V6_INDEPENDENCE_CLAIM
    || !nonEmpty(receipt.programId)) {
    errors.push("continuation review receipt V6 identity/assurance is invalid");
  }
  ...
  for (const key of [
    ...
    if (!sha256DigestV6(receipt[key])) errors.push(`receipt ${key} must be SHA-256`);
  }
...
export function validateContinuationReviewSetV6(
  receipts,
  callerDispatchSet,
  snapshot,
  policy,
  ...
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V6_REVIEW_LANES.length
    || !Array.isArray(callerDispatchSet)
    || callerDispatchSet.length !== CONTINUATION_V6_REVIEW_LANES.length) {
    return ["V6 review set requires exactly three receipts and dispatch-set entries"];
  }
  const contextIds = [];
  const dispatchSetDigest = hashCanonicalV6(callerDispatchSet);
  for (let index = 0; index < CONTINUATION_V6_REVIEW_LANES.length; index += 1) {
    const lane = CONTINUATION_V6_REVIEW_LANES[index];
    const receipt = receipts[index];
    const caller = callerDispatchSet[index];
    if (!plainObject(caller) || !exactKeys(caller, DISPATCH_SET_ENTRY_KEYS)
      || caller.lane !== lane
      || caller.assurance !== CONTINUATION_V6_CALLER_DISPATCH_ASSURANCE
      || caller.transport !== "codex-collaboration"
      || !sha256DigestV6(caller.challenge)
      || !sha256DigestV6(caller.instructionDigest)
    ...
    errors.push(...validateContinuationReviewReceiptV6(receipt, snapshot, policy, {
      callerPin: {
        challenge: caller.challenge,
        dispatchEntryDigest: hashCanonicalV6(caller),
        dispatchSetDigest,
      },
    }));
  ...
  if (new Set(contextIds).size !== CONTINUATION_V6_REVIEW_LANES.length) {
    errors.push("caller must attest three distinct reviewContextId values");
  }
  return unique(errors);
}

export function validateContinuationClosureManifestV6(manifest, bindings = {}) {
  const errors = [];
  if (!plainObject(manifest) || !exactKeys(manifest, MANIFEST_KEYS)) {
    return ["continuation closure manifest must contain the exact V6 keys"];
  }
  if (manifest.schemaVersion !== 6
    || manifest.kind !== CONTINUATION_V6_MANIFEST_KIND
    || manifest.workstreamId !== CONTINUATION_V6_WORKSTREAM_ID
    || manifest.featureId !== CONTINUATION_V6_FEATURE_ID
    || manifest.round !== CONTINUATION_V6_ROUND
    || !["review_passed_pending_external_transaction", "externally_attested"]
      .includes(manifest.status)) {
    errors.push("continuation closure manifest V6 identity/status is invalid");
  }
  validatePathDigest(manifest.policy, "manifest policy", errors);
  validatePathDigest(manifest.snapshot, "manifest snapshot", errors);
  validatePathDigest(manifest.round5ReviewRejection,
    "manifest Round5 rejection", errors);
  ...
  if (!sha256DigestV6(manifest.parentEvidenceBundleDigest)
    || !sha256DigestV6(manifest.pendingManifestDigest)) {
    errors.push("manifest parent/pending digest is invalid");
  }
  if (manifest.pendingManifestDigest !== pendingManifestDigestV6(manifest)) {
  ...
  if (!plainObject(manifest.externalAttestation)
    ...
    || !repositoryPathV6(manifest.externalAttestation.path)
    || (manifest.status === "review_passed_pending_external_transaction"
      ? manifest.externalAttestation.canonicalDigest !== null
      : !sha256DigestV6(manifest.externalAttestation.canonicalDigest))) {
  ...
  if (plainObject(bindings.policy)
    && (manifest.policy?.canonicalDigest !== bindings.policy.digest
      || manifest.round5ReviewRejection?.canonicalDigest
        !== bindings.policy.round5ReviewRejection?.digest)) {
  ...
  if (manifest.status === "externally_attested") {
    if (!plainObject(bindings.pendingManifest)
      ...
      || canonicalJsonV6(finalManifestProjectionV6(
        bindings.pendingManifest,
        bindings.externalAttestation.digest,
      )) !== canonicalJsonV6(withoutDigestV6(manifest))) {
...
export function pendingManifestDigestV6(manifest) {
...
export function finalManifestProjectionV6(pendingManifest, attestationDigest) {
  const projected = withoutDigestV6(pendingManifest);
...
export function validateContinuationExternalAttestationV6(
  attestation,
  bindings = {},
) {
  const errors = [];
  if (!plainObject(attestation) || !exactKeys(attestation, ATTESTATION_KEYS)) {
    return ["external attestation must contain the exact V6 keys"];
  }
  if (attestation.schemaVersion !== 6
    || attestation.kind !== CONTINUATION_V6_ATTESTATION_KIND
    || attestation.status !== "passed"
    || attestation.governancePhase !== "review_post_transition"
    || attestation.identityAssurance !== CONTINUATION_V6_IDENTITY_ASSURANCE
    || attestation.reviewAssurance !== CONTINUATION_V6_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(attestation.repositoryRealpath)) {
    errors.push("external attestation V6 identity/assurance is invalid");
  }
  for (const key of [
    "parentEvidenceBundleDigest", "pendingManifestDigest", "policyDigest",
    "round5ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV6(attestation[key])) errors.push(`attestation ${key} is invalid`);
  errors.push(...validateCallerDispatchSetShape(attestation.callerDispatchSet));
  validateCandidateResultsV6(
    attestation.candidateResults,
    bindings.policy,
    errors,
  );
  const completedAt = validateTimestampV6(
  ...
  if (!plainObject(bindings.policy)
    ...
    || !plainObject(bindings.round5ReviewRejection)
    ...
    const expected = {
      ...
      round5ReviewRejectionDigest: bindings.round5ReviewRejection.digest,
    ...
    if (canonicalJsonV6(attestation.callerDispatchSet)
      !== canonicalJsonV6(bindings.callerDispatchSet)) {
      errors.push("external attestation dispatch binding is stale");
    }
    if (Array.isArray(bindings.candidateResults)
      && canonicalJsonV6(attestation.candidateResults)
        !== canonicalJsonV6(bindings.candidateResults)) {
...
export function validateContinuationExternalAnchorV6(anchor, bindings = {}) {
  const errors = [];
  if (!plainObject(anchor) || !exactKeys(anchor, ANCHOR_KEYS)) {
    return ["external anchor must contain the exact V6 keys"];
  }
  if (anchor.schemaVersion !== 6
    || anchor.kind !== CONTINUATION_V6_ANCHOR_KIND
    || anchor.identityAssurance !== CONTINUATION_V6_IDENTITY_ASSURANCE
    || anchor.reviewAssurance !== CONTINUATION_V6_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(anchor.repositoryRealpath)) {
    errors.push("external anchor V6 identity/assurance is invalid");
  }
  for (const key of [
    "attestationDigest", "parentEvidenceBundleDigest", "policyDigest",
    "round5ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV6(anchor[key])) errors.push(`anchor ${key} is invalid`);
  ...
  if (!plainObject(bindings.attestation)
    ...
    if (canonicalJsonV6(anchor.callerDispatchSet)
      !== canonicalJsonV6(bindings.callerDispatchSet)) {
    ...
    if (canonicalJsonV6(anchor.head) !== canonicalJsonV6(expectedHead)) {
      errors.push("external anchor head is not the exact P107A successor-admission head");
    }
  }
  errors.push(...validateRejectedRound5AnchorSubjectV6(anchor));
...
export function serializeRound5ReviewRejectionV6(witness) {
  const errors = validateRound5ReviewRejectionV6(witness);
  if (errors.length > 0) throw new TypeError(errors.join("; "));
  return Buffer.from(`${JSON.stringify(witness, null, 2)}\n`, "utf8");
}

function validateCandidateResultsV6(results, policy, errors) {
  if (!Array.isArray(results)
    || results.length !== CONTINUATION_V6_CANDIDATE_RESULT_KINDS.length) {
  ...
  const expectedPaths = {
    ...CONTINUATION_V6_CANDIDATE_PATH_BY_KIND,
    checker: policyCheckerPath
      ?? CONTINUATION_V6_CANDIDATE_PATH_BY_KIND.checker,
  };
  for (let index = 0;
    index < CONTINUATION_V6_CANDIDATE_RESULT_KINDS.length;
    index += 1) {
    const result = results[index];
    const kind = CONTINUATION_V6_CANDIDATE_RESULT_KINDS[index];
    if (!plainObject(result)
      || !exactKeys(result, CANDIDATE_RESULT_KEYS)
      || result.kind !== kind
      || result.path !== expectedPaths[kind]
      || result.status !== "passed"
      || !sha256DigestV6(result.receiptDigest)
      || !sha256DigestV6(result.stdoutDigest)
      || !sha256DigestV6(result.stderrDigest)) {
      errors.push(`attestation candidateResults[${index}] is not exact ${kind} PASS evidence`);
    }
  }
}

function withoutDigestV6(value) {
  const projected = structuredClone(value);
  delete projected.digest;
  return projected;
}

function validateSnapshotAdmissionSubjectsV6(snapshot, policy, errors) {
  const byClass = new Map(
    CONTINUATION_V6_ADMISSION_CLASSES.map((value) => [value, []]),
  );
  ...
  for (const reference of [
    ...
    if (frozen.get(reference.path) !== reference.byteSha256) {
      errors.push(`snapshot does not freeze Round5 rejection evidence: ${reference.path}`);
    }
  }
  const rejectionBytes = sha256BytesV6(
    serializeRound5ReviewRejectionV6(policy.round5ReviewRejection),
  );
  if (frozen.get(CONTINUATION_V6_ROUND5_REVIEW_REJECTION_PATH)
    !== rejectionBytes) {
    errors.push("snapshot does not freeze exact Round5 review-rejection bytes");
  }
}

function validateSnapshotAuthoritySubjectsV6(snapshot, policy, errors) {
  const baseline = new Map((snapshot.baselineFiles ?? [])
    .map((entry) => [entry.path, entry.sha256]));
  const absent = new Set(snapshot.absentPaths ?? []);
  const expectedBaseline = new Map();
  const expectedAbsent = new Set(CONTINUATION_V6_REJECTED_OUTPUT_ABSENT_PATHS);
  for (const authority of policy.pathAuthorities ?? []) {
    if (authority.class === "modify"
  ...
  if (!sameMap(baseline, expectedBaseline)) {
    errors.push("snapshot baselineFiles do not exactly bind V6 baselines");
  }
...
function validateBaselineArchiveReferenceV6(reference, subject, errors) {
  if (!plainObject(reference)
    || !exactKeys(reference, ["digest", "entrySetDigest", "path"])
    || reference.path !== CONTINUATION_V6_BASELINE_ARCHIVE_PATH
    || !sha256DigestV6(reference.digest)
    || !sha256DigestV6(reference.entrySetDigest)) {
    errors.push(`${subject} is invalid`);
  }
}

function validateFileDigestArrayV6(entries, subject, errors) {
  ...
  for (const [index, entry] of entries.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, FILE_DIGEST_KEYS)
      || !repositoryPathV6(entry.path) || !sha256DigestV6(entry.sha256)) {
...
function validateStringPathsV6(entries, subject, errors) {
  if (!Array.isArray(entries)) {
    errors.push(`${subject} must be an array`);
    return;
  }
  if (entries.some((entry) => !repositoryPathV6(entry))) {
    errors.push(`${subject} contains an invalid path`);
  }
  validateSortedUnique(entries, subject, errors);
}

function validateTimestampV6(value, verifierNow, subject, errors) {
...
function validateFailedReceiptReferences(receipts, errors) {
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V6_ROUND5_RECEIPT_TRUST_ROOTS.length) {
    errors.push("Round5 rejection must bind exactly the governance failed receipt");
    return;
  }
  for (let index = 0; index < receipts.length; index += 1) {
    const actual = receipts[index];
    const expected = CONTINUATION_V6_ROUND5_RECEIPT_TRUST_ROOTS[index];
    if (!plainObject(actual) || !exactKeys(actual, FAILED_RECEIPT_REFERENCE_KEYS)
      ...
      || !sameExactObject(actual.findingCounts, expected.findingCounts,
        FINDING_COUNT_KEYS)) {
      errors.push(`Round5 failed receipt root differs for lane ${expected.lane}`);
    }
  }
}
...
function validateReviewAssurancePolicy(value, errors) {
  ...
  if (!plainObject(value) || !exactKeys(value, keys)
    || value.callerDispatchAssurance !== CONTINUATION_V6_CALLER_DISPATCH_ASSURANCE
    || value.identityAssurance !== CONTINUATION_V6_IDENTITY_ASSURANCE
    || value.independenceClaim !== CONTINUATION_V6_INDEPENDENCE_CLAIM
...
function validateExecutableRoots(policy, errors) {
  if (!Array.isArray(policy.continuationExecutables)
    || canonicalJsonV6(policy.continuationExecutables.map((entry) => entry?.kind))
      !== canonicalJsonV6(CONTINUATION_V6_EXECUTABLE_KINDS)) {
    errors.push("continuationExecutables must contain the exact ordered V6 kinds");
    return;
  }
  for (const [index, entry] of policy.continuationExecutables.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, ["kind", "path", "sha256"])
      || entry.path !== CONTINUATION_V6_EXECUTABLE_PATH_BY_KIND[entry.kind]
      || !repositoryPathV6(entry.path) || !sha256DigestV6(entry.sha256)) {
  ...
  if (canonicalJsonV6(actualSubset) !== canonicalJsonV6(expectedTrustRoots)) {
    errors.push("trustRoots do not bind every V6 transition and executable byte");
  }
}
...
function validateCallerDispatchSetShape(entries) {
  const errors = [];
  if (!Array.isArray(entries)
    || entries.length !== CONTINUATION_V6_REVIEW_LANES.length) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, DISPATCH_SET_ENTRY_KEYS)
      || entry.lane !== CONTINUATION_V6_REVIEW_LANES[index]
      || entry.assurance !== CONTINUATION_V6_CALLER_DISPATCH_ASSURANCE
      || entry.transport !== "codex-collaboration"
      || !sha256DigestV6(entry.challenge)
      || !sha256DigestV6(entry.instructionDigest)
...
function validateReviewReferences(entries, errors) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, REVIEW_REFERENCE_KEYS)
      ...
      || !repositoryPathV6(entry.path)
      || !sha256DigestV6(entry.challenge)
      || !sha256DigestV6(entry.canonicalDigest)) {
...
function validateFindings(receipt, errors) {
  ...
  if (canonicalJsonV6(actual) !== canonicalJsonV6(receipt.findingCounts)) {
...
function validatePathDigest(value, label, errors) {
  if (!plainObject(value)
    ...
    || !repositoryPathV6(value.path)
    || !sha256DigestV6(value.byteSha256)
    || !sha256DigestV6(value.canonicalDigest)) {
...
function validatePathSha(value, label, errors) {
  if (!plainObject(value) || !exactKeys(value, ["path", "sha256"])
    || !repositoryPathV6(value.path) || !sha256DigestV6(value.sha256)) {
    errors.push(`${label} is invalid`);
  }
}

function validateCanonicalDigest(value, label, errors) {
  if (!sha256DigestV6(value?.digest)) {
    errors.push(`${label} digest must be SHA-256`);
    return;
  }
  const withoutDigest = { ...value };
  delete withoutDigest.digest;
  if (hashCanonicalV6(withoutDigest) !== value.digest) {
...
function sameExactObject(actual, expected, keys) {
  return plainObject(actual)
    ...
    && canonicalJsonV6(actual) === canonicalJsonV6(expected);
}

function exactKeys(value, expected) {
  if (!plainObject(value)) return false;
  return canonicalJsonV6(Object.keys(value).sort())
    === canonicalJsonV6([...expected].sort());
}
...
function validateSortedUnique(values, label, errors) {
  ...
  if (new Set(values).size !== values.length
    || canonicalJsonV6(values) !== canonicalJsonV6(sorted)) {
    errors.push(`${label} must be sorted and unique`);
  }
}

function sameStringSet(left, right) {
  return canonicalJsonV6([...new Set(left)].sort())
    === canonicalJsonV6([...new Set(right)].sort());
}

function sameMap(left, right) {
  const project = (value) =>
    [...value.entries()].sort(([a], [b]) => a.localeCompare(b));
  return canonicalJsonV6(project(left)) === canonicalJsonV6(project(right));
}
...
export const canonicalJson = canonicalJsonV6;
export const hashCanonical = hashCanonicalV6;
export const sha256Bytes = sha256BytesV6;
export const validateRound5ReviewRejection = validateRound5ReviewRejectionV6;
export const validateAdmissionCoverage = validateAdmissionCoverageV6;
export const validateContinuationPolicy = validateContinuationPolicyV6;
export const validateBaselineArchive = validateBaselineArchiveV6;
export const validateReviewSnapshotV6 = validateContinuationReviewSnapshotV6;
export const validateReviewSnapshot = validateContinuationReviewSnapshotV6;
export const validateReviewReceiptV6 = validateContinuationReviewReceiptV6;
export const validateReviewSetV6 = validateContinuationReviewSetV6;
export const validateClosureManifestV6 = validateContinuationClosureManifestV6;
export const validateExternalAttestationV6 =
  validateContinuationExternalAttestationV6;
export const validateExternalAnchorV6 = validateContinuationExternalAnchorV6;
