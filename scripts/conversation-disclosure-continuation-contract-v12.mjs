...
export const CONTINUATION_V12_ALGORITHM = "sha256-canonical-json-v1";
export const CONTINUATION_V12_POLICY_KIND =
  "conversation-disclosure-continuation-policy";
export const CONTINUATION_V12_SNAPSHOT_KIND =
  "conversation-disclosure-continuation-review-snapshot";
export const CONTINUATION_V12_RECEIPT_KIND =
  "conversation-disclosure-continuation-review-receipt";
export const CONTINUATION_V12_MANIFEST_KIND =
  "conversation-disclosure-continuation-closure-manifest";
export const CONTINUATION_V12_ATTESTATION_KIND =
  "conversation-disclosure-continuation-external-attestation";
export const CONTINUATION_V12_ANCHOR_KIND =
  "conversation-disclosure-continuation-external-anchor";
export const CONTINUATION_V12_REVIEW_REJECTION_KIND =
  "conversation-disclosure-continuation-review-rejection";
export const CONTINUATION_V12_BASELINE_ARCHIVE_KIND =
  "conversation-disclosure-continuation-baseline-archive";

export const CONTINUATION_V12_POLICY_ID = "CD03A-round12-P108-admission-v12";
export const CONTINUATION_V12_WORKSTREAM_ID = "CD03A";
export const CONTINUATION_V12_FEATURE_ID =
  "P107A-conversation-disclosure-successor-admission";
export const CONTINUATION_V12_SUCCESSOR_WORKSTREAM_ID = "CD04";
export const CONTINUATION_V12_SUCCESSOR_FEATURE_ID =
  "P108-conversation-disclosure-evidence-foundation";
export const CONTINUATION_V12_ROUND = 12;
export const CONTINUATION_V12_REJECTED_ROUND = 11;

export const CONTINUATION_V12_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round12-successor-evolution-policy.json";
export const CONTINUATION_V12_BASELINE_ARCHIVE_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round12-baseline-archive.json";
export const CONTINUATION_V12_REVIEW_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round12-review-snapshot.json";
export const CONTINUATION_V12_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round12-closure-manifest.json";
export const CONTINUATION_V12_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round12-external-attestation.json";
export const CONTINUATION_V12_ROUND11_REVIEW_REJECTION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-review-rejection.json";

export const CONTINUATION_V12_ROUND11_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-successor-evolution-policy.json";
export const CONTINUATION_V12_ROUND11_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-review-snapshot.json";
export const CONTINUATION_V12_ROUND11_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-closure-manifest.json";
export const CONTINUATION_V12_ROUND11_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-external-attestation.json";

export const CONTINUATION_V12_REVIEW_LANES = Object.freeze([
  "contract", "runtime", "governance",
]);
export const CONTINUATION_V12_LIFECYCLE_PHASES = Object.freeze([
  "rejection_recorded",
  "policy_draft",
  "policy_published",
...
export const CONTINUATION_V12_LIFECYCLE_PROFILE_PHASES = Object.freeze([
  "review_pre_transition",
  "review_post_transition",
  "anchored_planned",
  "authorized_active",
]);
export const CONTINUATION_V12_EXECUTABLE_KINDS = Object.freeze([
  "checker", "contract", "freezer", "governance", "runner",
]);
export const CONTINUATION_V12_ADMISSION_CLASSES = Object.freeze([
  "frozen_file",
  "transition_live",
  "transition_payload",
  "post_review_mutable",
...
export const CONTINUATION_V12_ADMISSION_CLASS_SET_DIGEST =
  hashCanonicalV3(CONTINUATION_V12_ADMISSION_CLASSES);
export const CONTINUATION_V12_EXECUTABLE_PATH_BY_KIND = Object.freeze({
  checker: "scripts/check-conversation-disclosure-continuation-v12.mjs",
  contract: "scripts/conversation-disclosure-continuation-contract-v12.mjs",
  freezer: "scripts/freeze-conversation-disclosure-continuation-v12.mjs",
  governance: "scripts/conversation-disclosure-program-governance-v12.mjs",
  runner: "scripts/verify-conversation-disclosure-continuation-v12.mjs",
});
export const CONTINUATION_V12_GOVERNANCE_TRANSITIONS = Object.freeze({
...
export const CONTINUATION_V12_TARGET_PATH_BY_LIVE_PATH = Object.freeze({
  "package.json":
    ".zerox/verification/conversation-disclosure/CD03A-round12-package.target.json",
  "scripts/check-harness-state.mjs":
    ".zerox/verification/conversation-disclosure/CD03A-round12-harness.target.mjs",
  "src/shared/conversationDisclosureProgram.test.ts":
    ".zerox/verification/conversation-disclosure/CD03A-round12-program-test.target.ts",
  "src/shared/packageScripts.test.ts":
    ".zerox/verification/conversation-disclosure/CD03A-round12-package-scripts-test.target.ts",
});
export const CONTINUATION_V12_GOVERNANCE_TRANSITION_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    path: "package.json",
    kind: CONTINUATION_V12_GOVERNANCE_TRANSITIONS["package.json"],
    fromSha256:
      "sha256:560fb3e3b2829a32b4ac694c7781fce9e53941a9e20fc4ec1c08602d53c278b9",
    stagedTargetPath: CONTINUATION_V12_TARGET_PATH_BY_LIVE_PATH["package.json"],
    toSha256:
      "sha256:cba952d898990a9c1d229306c1b6e4314415a060ee62c51e8b983c52443041e9",
  }),
  Object.freeze({
    path: "scripts/check-harness-state.mjs",
    kind: CONTINUATION_V12_GOVERNANCE_TRANSITIONS["scripts/check-harness-state.mjs"],
    fromSha256:
      "sha256:231d28280f6891f50f5c714b4161d1b9d93cf171e0b67396de67ce7a36e06339",
    stagedTargetPath:
      CONTINUATION_V12_TARGET_PATH_BY_LIVE_PATH["scripts/check-harness-state.mjs"],
    toSha256:
      "sha256:34e3f4d19ea3766949782a93745e2ab6ea3c7c3074ace4e77f0d86ea7a2bb3cd",
  }),
  Object.freeze({
    path: "src/shared/conversationDisclosureProgram.test.ts",
    kind: CONTINUATION_V12_GOVERNANCE_TRANSITIONS[
      "src/shared/conversationDisclosureProgram.test.ts"
    ],
    fromSha256:
      "sha256:087cff0ba7f208464bf62e41f3a10dfbb88f3f2461d46398187c0b4cfa16dd5c",
    stagedTargetPath:
      CONTINUATION_V12_TARGET_PATH_BY_LIVE_PATH[
        "src/shared/conversationDisclosureProgram.test.ts"
      ],
    toSha256:
      "sha256:d5ee36e595ebb8f20e524c60765e1705369607de0952aabd6af0b273915e5546",
  }),
  Object.freeze({
    ...
    stagedTargetPath:
      CONTINUATION_V12_TARGET_PATH_BY_LIVE_PATH["src/shared/packageScripts.test.ts"],
    toSha256:
      "sha256:018893a42965272ecdfbd6badc7ab252c5d0f88f26518231295d1c937d3ffc5f",
  }),
]);
export const CONTINUATION_V12_CALLER_DISPATCH_ASSURANCE =
  "caller-attested-not-signed";
export const CONTINUATION_V12_IDENTITY_ASSURANCE = "not-signed";
export const CONTINUATION_V12_INDEPENDENCE_CLAIM =
  "caller-attested-distinct-review-contexts";
export const CONTINUATION_V12_CANDIDATE_RESULT_KINDS = Object.freeze([
  "checker",
  "harness",
]);
export const CONTINUATION_V12_CANDIDATE_PATH_BY_KIND = Object.freeze({
  checker: CONTINUATION_V12_EXECUTABLE_PATH_BY_KIND.checker,
  harness: "scripts/check-harness-state.mjs",
});

export const CONTINUATION_V12_ROUND11_POLICY_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V12_ROUND11_POLICY_PATH,
  byteSha256: "sha256:08b622a0e53f11431b7430f4a955dd8bcc8f1f5db8ddae29f839ec1f10c61920",
  canonicalDigest: "sha256:f8aed3d7f31a90f6c51c6e8884f3a71b55b92f350f49b846b91c8ac6a3c05d5e",
});
export const CONTINUATION_V12_ROUND11_SNAPSHOT_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V12_ROUND11_SNAPSHOT_PATH,
  byteSha256: "sha256:21b69d5e245667afbdf162ed32c9b15e69306e90b2a083fedf65a6e90d07ecdb",
  canonicalDigest: "sha256:93966f3852ede64c87894d71b2722999bbb1da99963073b0526bcada1232d21f",
  frozenFileCount: 327,
  transitionPayloadFileCount: 4,
  baselineFileCount: 12,
});

export const CONTINUATION_V12_ROUND11_RECEIPT_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    lane: "contract",
    path: ".zerox/verification/conversation-disclosure/CD03A-round11-contract-review.json",
    byteSha256: "sha256:22912a96d5bef4ec8a2df07c1af6947ba5a0a9d3417a5eddf75db1b2224310b1",
    canonicalDigest: "sha256:57f08bfcb4ba25d6a025147682fa441e9452a2ca2c164b9c56226d29262e0d88",
    challenge: "sha256:4100ec1f6bc737ec41e37b4ba33cfad2c61b9352b56515ae50def300cda80109",
    verdict: "passed",
    findingCounts: Object.freeze({ critical: 0, major: 0, minor: 0 }),
  }),
  Object.freeze({
    lane: "runtime",
    path: ".zerox/verification/conversation-disclosure/CD03A-round11-runtime-review.json",
    byteSha256: "sha256:c911637686cbd884a49facba75a70cedf1abe0f328befa64c841a2bace356ad4",
    canonicalDigest: "sha256:e2025a7bc548c10370de8fa226b1df9eb35e735c142c511563fbe7b7e8c68c0c",
    challenge: "sha256:3db0eb48160eeccb6e4a08d2ad3f4fb99a71aa2e5eeae19994d8d52795b88edd",
    verdict: "failed",
    findingCounts: Object.freeze({ critical: 0, major: 3, minor: 0 }),
  }),
  Object.freeze({
    lane: "governance",
    path: ".zerox/verification/conversation-disclosure/CD03A-round11-governance-review.json",
    byteSha256: "sha256:1d09681129535c1c5389aa4a18e41c2ef09ac0c8e23cbb3711578d38598c1a8a",
    canonicalDigest: "sha256:87226066a6318e7a1a7f23cfda91c681f3ebeb3bcba518ec9c383d9753b1663c",
    challenge: "sha256:d0cc7a5a3ac0805b466c9d4ec284f6d6ae2aee0adbb397115220f53aeb926caa",
    verdict: "passed",
    findingCounts: Object.freeze({ critical: 0, major: 0, minor: 0 }),
  }),
]);

export const CONTINUATION_V12_ROUND11_FINDING_IDS = Object.freeze([
  "R11-RUNTIME-001",
  "R11-RUNTIME-002",
  "R11-RUNTIME-003",
]);
export const CONTINUATION_V12_ROUND11_FINDING_SET_DIGEST =
  "sha256:d6e3763ba26567881445beef83ad4a8b11081af59e9961d7d6100f530e68a882";
export const CONTINUATION_V12_ROUND11_AGGREGATE_FINDING_COUNTS = Object.freeze({
  critical: 0,
  major: 3,
  minor: 0,
});
export const CONTINUATION_V12_ROUND1_REJECTION_DIGEST =
  "sha256:ec981e92f486ae75a56b3b4b393f95d095f6d684e6af54fe12cc7a9ba0fe1f99";
export const CONTINUATION_V12_ROUND2_REJECTION_TRUST_ROOT = Object.freeze({
...
export const CONTINUATION_V12_ROUND11_REPOSITORY_FORBIDDEN_OUTPUT_PATHS =
  Object.freeze([
    CONTINUATION_V12_ROUND11_CLOSURE_MANIFEST_PATH,
    CONTINUATION_V12_ROUND11_EXTERNAL_ATTESTATION_PATH,
  ].sort());
export const CONTINUATION_V12_ROUND1_REPOSITORY_FORBIDDEN_OUTPUT_PATHS =
  Object.freeze([...CONTINUATION_V2_ROUND1_FORBIDDEN_OUTPUT_PATHS].sort());
export const CONTINUATION_V12_REJECTED_OUTPUT_ABSENT_PATHS = Object.freeze([
  ...new Set([
    ...CONTINUATION_V2_ROUND1_FORBIDDEN_OUTPUT_PATHS,
    ...CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS,
...
export const CONTINUATION_V12_REVIEW_OUTPUT_PATHS = Object.freeze([
  CONTINUATION_V12_REVIEW_SNAPSHOT_PATH,
  ...CONTINUATION_V12_REVIEW_LANES.map((lane) =>
...
export const CONTINUATION_V12_RUNTIME_IO_INTERFACE = Object.freeze({
  schemaVersion: 1,
...
const ROUND11_REJECTION_KEYS = Object.freeze([
...
export const CONTINUATION_V12_POLICY_KEYS = POLICY_KEYS;
export const CONTINUATION_V12_SNAPSHOT_KEYS = SNAPSHOT_KEYS;
export const CONTINUATION_V12_BASELINE_ARCHIVE_KEYS = ARCHIVE_KEYS;
export const CONTINUATION_V12_REVIEW_REJECTION_KEYS = ROUND11_REJECTION_KEYS;
export const CONTINUATION_V12_RECEIPT_KEYS = RECEIPT_KEYS;
export const CONTINUATION_V12_MANIFEST_KEYS = MANIFEST_KEYS;

export const canonicalJsonV12 = canonicalJsonV3;
export const hashCanonicalV12 = hashCanonicalV3;
export const sha256BytesV12 = sha256BytesV3;
export const sha256DigestV12 = sha256DigestV3;
export const repositoryPathV12 = repositoryPathV3;
export const withCanonicalDigestV12 = withCanonicalDigestV3;
export const stableFeatureDefinitionV12 = stableFeatureDefinitionV3;
export const stableHistoricalFeatureDefinitionV12 =
  stableHistoricalFeatureDefinitionV3;
export const stableProgramRootDefinitionV12 = stableProgramRootDefinitionV3;
export const stableWorkstreamDefinitionV12 = stableWorkstreamDefinitionV3;

export function buildAdmissionCoverageV12(
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V12_REJECTED_OUTPUT_ABSENT_PATHS,
) {
  const files = admission?.featureDefinition?.files;
  if (!Array.isArray(files) || files.length === 0
    || new Set(files).size !== files.length
    || files.some((entry) => !repositoryPathV12(entry))) {
    throw new TypeError("P107A exact V12 file roster is invalid");
  }
  if (canonicalJsonV12(rejectedOutputAbsentPaths)
    !== canonicalJsonV12(CONTINUATION_V12_REJECTED_OUTPUT_ABSENT_PATHS)) {
    throw new TypeError("V12 rejected-output absence roster is not exact");
  }
  const byClass = new Map(CONTINUATION_V12_ADMISSION_CLASSES.map((entry) => [
    entry,
    new Set(),
  ]));
  ...
  return files.map((relativePath) => {
    const classes = CONTINUATION_V12_ADMISSION_CLASSES.filter((entry) =>
      entry !== "frozen_file" && byClass.get(entry).has(relativePath));
    if (classes.length > 1) {
      throw new TypeError(`V12 path has overlapping admission classes: ${relativePath}`);
    }
    return { path: relativePath, class: classes[0] ?? "frozen_file" };
  }).sort(comparePath);
}

export function validateAdmissionCoverageV12(
  coverage,
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V12_REJECTED_OUTPUT_ABSENT_PATHS,
  ...
  for (const [index, entry] of coverage.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, COVERAGE_KEYS)
      || !repositoryPathV12(entry.path)
      || !CONTINUATION_V12_ADMISSION_CLASSES.includes(entry.class)) {
  ...
  let expected;
  try {
    expected = buildAdmissionCoverageV12(
      admission,
      transitions,
  ...
  if (expected && canonicalJsonV12(coverage) !== canonicalJsonV12(expected)) {
    errors.push("admissionCoverage differs from the exact V12 classification");
  }
  ...
  for (const requiredClass of CONTINUATION_V12_ADMISSION_CLASSES) {
...
export function validateRound11ReviewRejectionV12(witness) {
  const errors = [];
  if (!plainObject(witness) || !exactKeys(witness, ROUND11_REJECTION_KEYS)) {
    return ["Round11 review rejection must contain the exact V12 keys"];
  }
  if (witness.schemaVersion !== 12
    || witness.kind !== CONTINUATION_V12_REVIEW_REJECTION_KIND
    || witness.algorithm !== CONTINUATION_V12_ALGORITHM
    || witness.workstreamId !== CONTINUATION_V12_WORKSTREAM_ID
    || witness.featureId !== CONTINUATION_V12_FEATURE_ID
    || witness.rejectedRound !== CONTINUATION_V12_REJECTED_ROUND
    || witness.recoveryRound !== CONTINUATION_V12_ROUND
    || witness.status !== "rejected_after_review"
    || !nonEmpty(witness.programId)) {
    errors.push("Round11 review rejection identity/status is invalid");
  }
  if (!sameExactObject(witness.sourcePolicy,
    CONTINUATION_V12_ROUND11_POLICY_TRUST_ROOT, POLICY_REFERENCE_KEYS)) {
    errors.push("Round11 policy reference differs from both hard trust roots");
  }
  if (!sameExactObject(witness.sourceSnapshot,
    CONTINUATION_V12_ROUND11_SNAPSHOT_TRUST_ROOT, SNAPSHOT_REFERENCE_KEYS)) {
    errors.push("Round11 snapshot reference differs from both hard trust roots");
  }
  validateCompletedReceiptReferences(witness.completedReceipts, errors);
  if (!sameExactObject(witness.aggregateFindingCounts,
    CONTINUATION_V12_ROUND11_AGGREGATE_FINDING_COUNTS, FINDING_COUNT_KEYS)) {
    errors.push("Round11 aggregate finding counts differ from the completed receipts");
  }
  if (canonicalJsonV12(witness.findingIds)
    !== canonicalJsonV12(CONTINUATION_V12_ROUND11_FINDING_IDS)
    || witness.findingSetDigest !== CONTINUATION_V12_ROUND11_FINDING_SET_DIGEST) {
    errors.push("Round11 finding set differs from the hard rejection root");
  }
  if (canonicalJsonV12(witness.repositoryForbiddenOutputs)
    !== canonicalJsonV12(CONTINUATION_V12_ROUND11_REPOSITORY_FORBIDDEN_OUTPUT_PATHS)) {
    errors.push("Round11 repository forbidden-output set is not exact");
  }
  const expectedAnchorRule = expectedRejectedRound11AnchorRuleV12();
  if (!sameExactObject(witness.externalAnchorRule, expectedAnchorRule,
    EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("Round11 external anchor rule is invalid or asserts fictional absence");
  }
  const expectedPrior = {
    round1CanonicalDigest: CONTINUATION_V12_ROUND1_REJECTION_DIGEST,
    round2: CONTINUATION_V12_ROUND2_REJECTION_TRUST_ROOT,
  };
  if (!plainObject(witness.priorRejections)
    ...
    errors.push("Round11 rejection does not bind the exact prior rejection chain");
  }
  validateCanonicalDigest(witness, "Round11 review rejection", errors);
  return unique(errors);
}

export function expectedRejectedRound11AnchorRuleV12() {
  return {
    policyDigest: CONTINUATION_V12_ROUND11_POLICY_TRUST_ROOT.canonicalDigest,
    snapshotDigest: CONTINUATION_V12_ROUND11_SNAPSHOT_TRUST_ROOT.canonicalDigest,
    admissibility: "forbidden",
    externalAbsenceClaim: "not_asserted",
  };
}

export function validateRejectedRound11AnchorSubjectV12(anchor) {
  if (!plainObject(anchor)) return ["external anchor candidate must be an object"];
  if (anchor.policyDigest === CONTINUATION_V12_ROUND11_POLICY_TRUST_ROOT.canonicalDigest
    && anchor.snapshotDigest
      === CONTINUATION_V12_ROUND11_SNAPSHOT_TRUST_ROOT.canonicalDigest) {
    return ["external anchor is bound to the rejected Round11 subject"];
  }
  return [];
}

export function validateRejectedOutputAbsenceCapturesV12(captures) {
  const errors = [];
  if (!Array.isArray(captures)) return ["absence captures must be an array"];
  const expected = CONTINUATION_V12_REJECTED_OUTPUT_ABSENT_PATHS.map((entry) => ({
    path: entry,
    presence: "absent",
  }));
  for (const [index, capture] of captures.entries()) {
    if (!plainObject(capture)
      ...
      || !repositoryPathV12(capture.path)
      || capture.presence !== "absent") {
      errors.push(`absence capture[${index}] is invalid`);
    }
  }
  if (canonicalJsonV12(captures) !== canonicalJsonV12(expected)) {
    errors.push("absence captures differ from the exact rejected-output roster");
  }
  return unique(errors);
}

export function validateRuntimeIoCaptureAdapterV12(adapter) {
  if (adapter === null || (typeof adapter !== "object"
    && typeof adapter !== "function")) {
    return ["runtime I/O adapter must be an object"];
  }
  return CONTINUATION_V12_RUNTIME_IO_INTERFACE.methods
    .filter((method) => typeof adapter[method] !== "function")
    .map((method) => `runtime I/O adapter misses ${method}`);
}

export function validateContinuationPolicyV12(policy, bindings = {}) {
  const errors = [];
  if (!plainObject(policy) || !exactKeys(policy, POLICY_KEYS)) {
    return ["continuation policy must contain the exact V12 keys"];
  }
  if (policy.schemaVersion !== 12
    || policy.kind !== CONTINUATION_V12_POLICY_KIND
    || policy.algorithm !== CONTINUATION_V12_ALGORITHM
    || policy.policyId !== CONTINUATION_V12_POLICY_ID
    || policy.workstreamId !== CONTINUATION_V12_WORKSTREAM_ID
    || policy.featureId !== CONTINUATION_V12_FEATURE_ID
    || policy.round !== CONTINUATION_V12_ROUND
    || policy.status !== "frozen"
    || !nonEmpty(policy.programId)) {
    errors.push("continuation policy V12 identity/status is invalid");
  }
  if (canonicalJsonV12(policy.admissionClassSet)
      !== canonicalJsonV12(CONTINUATION_V12_ADMISSION_CLASSES)
  ...
  errors.push(...validateRound11ReviewRejectionV12(policy.round11ReviewRejection));
  if (policy.round11ReviewRejection?.programId !== policy.programId) {
    errors.push("Round11 rejection programId differs from the continuation policy");
  }
  errors.push(...validateAdmissionDefinitionV2(policy.admission));
  errors.push(...validateAdmissionCoverageV12(
  ...
  if (canonicalJsonV12(policy.governanceTransitions)
    !== canonicalJsonV12(CONTINUATION_V12_GOVERNANCE_TRANSITION_TRUST_ROOTS)) {
    errors.push("V12 governance transitions differ from the Round12 target trust root");
  }
  ...
  if (!sameExactObject(policy.externalAnchorPolicy,
    expectedRejectedRound11AnchorRuleV12(), EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("policy externalAnchorPolicy does not forbid the rejected Round11 subject");
  }
  if (!plainObject(policy.reviewSnapshot)
    || !exactKeys(policy.reviewSnapshot, ["path"])
    || policy.reviewSnapshot.path !== CONTINUATION_V12_REVIEW_SNAPSHOT_PATH) {
    errors.push("policy reviewSnapshot path is invalid");
  }
  validateBaselineArchiveReferenceV12(
  ...
  if (canonicalJsonV12(rejectedCoverage)
    !== canonicalJsonV12(CONTINUATION_V12_REJECTED_OUTPUT_ABSENT_PATHS)) {
  ...
  if (bindings.expectedAdmissionRoots !== undefined) {
    ...
    if (!plainObject(roots)
      ...
      for (const [key, actual] of [
        ...
        if (!sha256DigestV12(roots[key]) || roots[key] !== actual) {
  ...
  if (bindings.baselineArchive !== undefined) {
    errors.push(...validateBaselineArchiveV12(bindings.baselineArchive, policy));
  }
  if (bindings.lifecycleState !== undefined) {
    errors.push(...validateLifecycleStateV12(bindings.lifecycleState, policy));
  }
  return unique(errors);
}

export function validateBaselineArchiveV12(archive, policy) {
  const errors = [];
  if (!plainObject(archive) || !exactKeys(archive, ARCHIVE_KEYS)) {
    return ["baseline archive must contain the exact V12 keys"];
  }
  if (archive.schemaVersion !== 12
    || archive.kind !== CONTINUATION_V12_BASELINE_ARCHIVE_KIND
    || archive.algorithm !== CONTINUATION_V12_ALGORITHM
    || archive.workstreamId !== CONTINUATION_V12_WORKSTREAM_ID
    || archive.featureId !== CONTINUATION_V12_FEATURE_ID
    || archive.round !== CONTINUATION_V12_ROUND
    || !nonEmpty(archive.programId)) {
    errors.push("baseline archive V12 identity is invalid");
  }
  ...
  for (const [index, entry] of (archive.entries ?? []).entries()) {
    ...
    try {
      ...
      if (sha256BytesV12(decoded) !== entry.sha256) throw new Error("digest");
    } catch {
  ...
  if (plainObject(policy)) {
    ...
    if (canonicalJsonV12(actual) !== canonicalJsonV12(expected)) {
...
export function validateContinuationReviewSnapshotV12(
  snapshot,
  policy,
  bindings = {},
) {
  ...
  if (!plainObject(snapshot) || !exactKeys(snapshot, SNAPSHOT_KEYS)) {
    return ["continuation review snapshot must contain the exact V12 keys"];
  }
  if (snapshot.schemaVersion !== 12
    || snapshot.kind !== CONTINUATION_V12_SNAPSHOT_KIND
    || snapshot.algorithm !== CONTINUATION_V12_ALGORITHM
    || snapshot.workstreamId !== CONTINUATION_V12_WORKSTREAM_ID
    || snapshot.featureId !== CONTINUATION_V12_FEATURE_ID
    || snapshot.round !== CONTINUATION_V12_ROUND
    || !nonEmpty(snapshot.programId)) {
    errors.push("continuation review snapshot V12 identity is invalid");
  }
  validateTimestampV12(
    snapshot.frozenAt,
  ...
  ]) validateFileDigestArrayV12(snapshot[key], label, errors);
  validateStringPathsV12(snapshot.absentPaths, "snapshot absentPaths", errors);
  validateStringPathsV12(
  ...
  if (plainObject(policy)) {
    const expectedBindings = {
      ...
      round11ReviewRejectionDigest: policy.round11ReviewRejection?.digest,
    };
    ...
    if (canonicalJsonV12(snapshot.governanceTransitions)
      !== canonicalJsonV12(policy.governanceTransitions)) {
      errors.push("snapshot governance transitions differ from policy");
    }
    if (canonicalJsonV12(snapshot.baselineArchive)
      !== canonicalJsonV12(policy.baselineArchive)) {
      errors.push("snapshot baselineArchive differs from policy");
    }
    validateSnapshotAdmissionSubjectsV12(snapshot, policy, errors);
    validateSnapshotAuthoritySubjectsV12(snapshot, policy, errors);
  }
  validateCanonicalDigest(snapshot, "continuation review snapshot", errors);
  return unique(errors);
}

export function validateGovernanceTransitionStateV12(
  transitions,
  phase,
  liveDigests,
  stagedDigests,
  ...
  if (canonicalJsonV12(pathKinds)
    !== canonicalJsonV12(CONTINUATION_V12_GOVERNANCE_TRANSITIONS)) {
    errors.push("V12 governance transition path/kind set is not exact");
  }
...
export function validateLifecycleStateV12(live, policy) {
  return validateLifecycleStateV2(live, policy);
}

export function selectLifecycleProfileV12(policy, phase) {
  if (!CONTINUATION_V12_LIFECYCLE_PROFILE_PHASES.includes(phase)) {
    return undefined;
  }
...
export function validateContinuationReviewReceiptV12(
  receipt,
  snapshot,
  policy,
  bindings = {},
  ...
  if (!plainObject(receipt) || !exactKeys(receipt, RECEIPT_KEYS)) {
    return ["continuation review receipt must contain the exact V12 keys"];
  }
  if (receipt.schemaVersion !== 12
    || receipt.kind !== CONTINUATION_V12_RECEIPT_KIND
    || receipt.workstreamId !== CONTINUATION_V12_WORKSTREAM_ID
    || receipt.featureId !== CONTINUATION_V12_FEATURE_ID
    || receipt.round !== CONTINUATION_V12_ROUND
    || !CONTINUATION_V12_REVIEW_LANES.includes(receipt.lane)
    || receipt.reviewedPhase !== "review_pre_transition"
    || receipt.identityAssurance !== CONTINUATION_V12_IDENTITY_ASSURANCE
    || receipt.independenceClaim !== CONTINUATION_V12_INDEPENDENCE_CLAIM
    || !nonEmpty(receipt.programId)) {
    errors.push("continuation review receipt V12 identity/assurance is invalid");
  }
  ...
  for (const key of [
    ...
    if (!sha256DigestV12(receipt[key])) errors.push(`receipt ${key} must be SHA-256`);
  }
  validateFindings(receipt, errors);
  const completedAt = validateTimestampV12(
    receipt.completedAt,
    bindings.verifierNow,
    "receipt completedAt",
    errors,
  ...
  if (plainObject(snapshot) && plainObject(policy)) {
    ...
    const validator = policy.continuationExecutables?.find(
      (entry) => entry?.kind === "checker"
        && entry?.path === CONTINUATION_V12_EXECUTABLE_PATH_BY_KIND.checker,
    );
    const expected = {
      programId: policy.programId,
...
export function validateContinuationReviewSetV12(
  receipts,
  callerDispatchSet,
  snapshot,
  policy,
  ...
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V12_REVIEW_LANES.length
    || !Array.isArray(callerDispatchSet)
    || callerDispatchSet.length !== CONTINUATION_V12_REVIEW_LANES.length) {
    return ["V12 review set requires exactly three receipts and dispatch-set entries"];
  }
  const contextIds = [];
  const dispatchSetDigest = hashCanonicalV12(callerDispatchSet);
  for (let index = 0; index < CONTINUATION_V12_REVIEW_LANES.length; index += 1) {
    const lane = CONTINUATION_V12_REVIEW_LANES[index];
    const receipt = receipts[index];
    const caller = callerDispatchSet[index];
    if (!plainObject(caller) || !exactKeys(caller, DISPATCH_SET_ENTRY_KEYS)
      || caller.lane !== lane
      || caller.assurance !== CONTINUATION_V12_CALLER_DISPATCH_ASSURANCE
      || caller.transport !== "codex-collaboration"
      || !sha256DigestV12(caller.challenge)
      || !sha256DigestV12(caller.instructionDigest)
    ...
    errors.push(...validateContinuationReviewReceiptV12(receipt, snapshot, policy, {
      callerPin: {
        challenge: caller.challenge,
        dispatchEntryDigest: hashCanonicalV12(caller),
        dispatchSetDigest,
      },
  ...
  if (new Set(contextIds).size !== CONTINUATION_V12_REVIEW_LANES.length) {
    errors.push("caller must attest three distinct reviewContextId values");
  }
  return unique(errors);
}

export function validateContinuationClosureManifestV12(manifest, bindings = {}) {
  const errors = [];
  if (!plainObject(manifest) || !exactKeys(manifest, MANIFEST_KEYS)) {
    return ["continuation closure manifest must contain the exact V12 keys"];
  }
  if (manifest.schemaVersion !== 12
    || manifest.kind !== CONTINUATION_V12_MANIFEST_KIND
    || manifest.workstreamId !== CONTINUATION_V12_WORKSTREAM_ID
    || manifest.featureId !== CONTINUATION_V12_FEATURE_ID
    || manifest.round !== CONTINUATION_V12_ROUND
    || !["review_passed_pending_external_transaction", "externally_attested"]
      .includes(manifest.status)) {
    errors.push("continuation closure manifest V12 identity/status is invalid");
  }
  ...
  validatePathDigest(manifest.round11ReviewRejection,
    "manifest Round11 rejection", errors);
  ...
  if (manifest.policy?.path !== CONTINUATION_V12_POLICY_PATH
    || manifest.snapshot?.path !== CONTINUATION_V12_REVIEW_SNAPSHOT_PATH
    || manifest.round11ReviewRejection?.path
      !== CONTINUATION_V12_ROUND11_REVIEW_REJECTION_PATH
    || manifest.validator?.path
      !== CONTINUATION_V12_EXECUTABLE_PATH_BY_KIND.checker
    || manifest.externalRunner?.path
      !== CONTINUATION_V12_EXECUTABLE_PATH_BY_KIND.runner) {
    errors.push("manifest evidence paths differ from canonical Round12 roots");
  }
  ...
  if (!sha256DigestV12(manifest.parentEvidenceBundleDigest)
    || !sha256DigestV12(manifest.pendingManifestDigest)) {
    errors.push("manifest parent/pending digest is invalid");
  }
  if (manifest.pendingManifestDigest !== pendingManifestDigestV12(manifest)) {
  ...
  if (!plainObject(manifest.externalAttestation)
    ...
    || (manifest.status === "review_passed_pending_external_transaction"
      ...
      : !sha256DigestV12(manifest.externalAttestation.canonicalDigest))) {
    errors.push("manifest external attestation reference is invalid");
  }
  if (plainObject(bindings.policy)
    && (manifest.policy?.canonicalDigest !== bindings.policy.digest
      || manifest.round11ReviewRejection?.canonicalDigest
        !== bindings.policy.round11ReviewRejection?.digest)) {
  ...
  if (manifest.status === "externally_attested") {
    if (!plainObject(bindings.pendingManifest)
      ...
      || canonicalJsonV12(finalManifestProjectionV12(
        bindings.pendingManifest,
        bindings.externalAttestation.digest,
      )) !== canonicalJsonV12(withoutDigestV12(manifest))) {
...
export function pendingManifestDigestV12(manifest) {
...
export function finalManifestProjectionV12(pendingManifest, attestationDigest) {
  const projected = withoutDigestV12(pendingManifest);
...
export function validateContinuationExternalAttestationV12(
  attestation,
  bindings = {},
) {
  const errors = [];
  if (!plainObject(attestation) || !exactKeys(attestation, ATTESTATION_KEYS)) {
    return ["external attestation must contain the exact V12 keys"];
  }
  if (attestation.schemaVersion !== 12
    || attestation.kind !== CONTINUATION_V12_ATTESTATION_KIND
    || attestation.status !== "passed"
    || attestation.governancePhase !== "review_post_transition"
    || attestation.identityAssurance !== CONTINUATION_V12_IDENTITY_ASSURANCE
    || attestation.reviewAssurance !== CONTINUATION_V12_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(attestation.repositoryRealpath)) {
    errors.push("external attestation V12 identity/assurance is invalid");
  }
  for (const key of [
    "parentEvidenceBundleDigest", "pendingManifestDigest", "policyDigest",
    "round11ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV12(attestation[key])) errors.push(`attestation ${key} is invalid`);
  errors.push(...validateCallerDispatchSetShape(attestation.callerDispatchSet));
  validateCandidateResultsV12(
  ...
  if (!plainObject(bindings.policy)
    ...
    || !plainObject(bindings.round11ReviewRejection)
    ...
    const expected = {
      ...
      round11ReviewRejectionDigest: bindings.round11ReviewRejection.digest,
    ...
    if (canonicalJsonV12(attestation.callerDispatchSet)
      !== canonicalJsonV12(bindings.callerDispatchSet)) {
      errors.push("external attestation dispatch binding is stale");
    }
    if (canonicalJsonV12(attestation.candidateResults)
      !== canonicalJsonV12(bindings.candidateResults)) {
...
export function validateContinuationExternalAnchorV12(anchor, bindings = {}) {
  const errors = [];
  if (!plainObject(anchor) || !exactKeys(anchor, ANCHOR_KEYS)) {
    return ["external anchor must contain the exact V12 keys"];
  }
  if (anchor.schemaVersion !== 12
    || anchor.kind !== CONTINUATION_V12_ANCHOR_KIND
    || anchor.identityAssurance !== CONTINUATION_V12_IDENTITY_ASSURANCE
    || anchor.reviewAssurance !== CONTINUATION_V12_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(anchor.repositoryRealpath)) {
    errors.push("external anchor V12 identity/assurance is invalid");
  }
  for (const key of [
    "attestationDigest", "parentEvidenceBundleDigest", "policyDigest",
    "round11ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV12(anchor[key])) errors.push(`anchor ${key} is invalid`);
  errors.push(...validateCallerDispatchSetShape(anchor.callerDispatchSet));
  validateCandidateResultsV12(anchor.candidateResults, bindings.policy, errors);
  ...
  if (!plainObject(bindings.attestation)
    ...
    if (canonicalJsonV12(anchor.callerDispatchSet)
      !== canonicalJsonV12(bindings.callerDispatchSet)) {
      errors.push("external anchor dispatch binding is stale");
    }
    if (canonicalJsonV12(anchor.candidateResults)
      !== canonicalJsonV12(bindings.attestation.candidateResults)) {
    ...
    if (canonicalJsonV12(anchor.head) !== canonicalJsonV12(expectedHead)) {
      errors.push("external anchor head is not the exact P107A successor-admission head");
    }
  }
  errors.push(...validateRejectedRound11AnchorSubjectV12(anchor));
...
export function serializeRound11ReviewRejectionV12(witness) {
  const errors = validateRound11ReviewRejectionV12(witness);
  if (errors.length > 0) throw new TypeError(errors.join("; "));
  return Buffer.from(`${JSON.stringify(witness, null, 2)}\n`, "utf8");
}

function validateCandidateResultsV12(results, policy, errors) {
  if (!Array.isArray(results)
    || results.length !== CONTINUATION_V12_CANDIDATE_RESULT_KINDS.length) {
  ...
  const expectedPaths = {
    ...CONTINUATION_V12_CANDIDATE_PATH_BY_KIND,
    checker: policyCheckerPath
      ?? CONTINUATION_V12_CANDIDATE_PATH_BY_KIND.checker,
  };
  for (let index = 0;
    index < CONTINUATION_V12_CANDIDATE_RESULT_KINDS.length;
    index += 1) {
    const result = results[index];
    const kind = CONTINUATION_V12_CANDIDATE_RESULT_KINDS[index];
    if (!plainObject(result)
      || !exactKeys(result, CANDIDATE_RESULT_KEYS)
      || result.kind !== kind
      || result.path !== expectedPaths[kind]
      || result.status !== "passed"
      || !sha256DigestV12(result.receiptDigest)
      || !sha256DigestV12(result.stdoutDigest)
      || !sha256DigestV12(result.stderrDigest)) {
      errors.push(`attestation candidateResults[${index}] is not exact ${kind} PASS evidence`);
    }
  }
}

function withoutDigestV12(value) {
  const projected = structuredClone(value);
  delete projected.digest;
  return projected;
}

function validateSnapshotAdmissionSubjectsV12(snapshot, policy, errors) {
  const byClass = new Map(
    CONTINUATION_V12_ADMISSION_CLASSES.map((value) => [value, []]),
  );
  ...
  for (const reference of [
    ...
    if (frozen.get(reference.path) !== reference.byteSha256) {
      errors.push(`snapshot does not freeze Round11 rejection evidence: ${reference.path}`);
    }
  }
  const rejectionBytes = sha256BytesV12(
    serializeRound11ReviewRejectionV12(policy.round11ReviewRejection),
  );
  if (frozen.get(CONTINUATION_V12_ROUND11_REVIEW_REJECTION_PATH)
    !== rejectionBytes) {
    errors.push("snapshot does not freeze exact Round11 review-rejection bytes");
  }
}

function validateSnapshotAuthoritySubjectsV12(snapshot, policy, errors) {
  const baseline = new Map((snapshot.baselineFiles ?? [])
    .map((entry) => [entry.path, entry.sha256]));
  const absent = new Set(snapshot.absentPaths ?? []);
  const expectedBaseline = new Map();
  const expectedAbsent = new Set(CONTINUATION_V12_REJECTED_OUTPUT_ABSENT_PATHS);
  for (const authority of policy.pathAuthorities ?? []) {
    if (authority.class === "modify"
  ...
  if (!sameMap(baseline, expectedBaseline)) {
    errors.push("snapshot baselineFiles do not exactly bind V12 baselines");
  }
...
function validateBaselineArchiveReferenceV12(reference, subject, errors) {
  if (!plainObject(reference)
    || !exactKeys(reference, ["digest", "entrySetDigest", "path"])
    || reference.path !== CONTINUATION_V12_BASELINE_ARCHIVE_PATH
    || !sha256DigestV12(reference.digest)
    || !sha256DigestV12(reference.entrySetDigest)) {
    errors.push(`${subject} is invalid`);
  }
}

function validateFileDigestArrayV12(entries, subject, errors) {
  ...
  for (const [index, entry] of entries.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, FILE_DIGEST_KEYS)
      || !repositoryPathV12(entry.path) || !sha256DigestV12(entry.sha256)) {
...
function validateStringPathsV12(entries, subject, errors) {
  if (!Array.isArray(entries)) {
    errors.push(`${subject} must be an array`);
    return;
  }
  if (entries.some((entry) => !repositoryPathV12(entry))) {
    errors.push(`${subject} contains an invalid path`);
  }
  validateSortedUnique(entries, subject, errors);
}

function validateTimestampV12(value, verifierNow, subject, errors) {
...
function validateCompletedReceiptReferences(receipts, errors) {
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V12_ROUND11_RECEIPT_TRUST_ROOTS.length) {
    errors.push("Round11 rejection must bind every completed review receipt");
    return;
  }
  for (let index = 0; index < receipts.length; index += 1) {
    ...
    if (!plainObject(actual) || !exactKeys(actual, COMPLETED_RECEIPT_REFERENCE_KEYS)
      ...
      || !sameExactObject(actual.findingCounts, expected.findingCounts,
        FINDING_COUNT_KEYS)) {
      errors.push(`Round11 completed receipt root differs for lane ${expected.lane}`);
    }
  }
}
...
function validateReviewAssurancePolicy(value, errors) {
  ...
  if (!plainObject(value) || !exactKeys(value, keys)
    || value.callerDispatchAssurance !== CONTINUATION_V12_CALLER_DISPATCH_ASSURANCE
    || value.identityAssurance !== CONTINUATION_V12_IDENTITY_ASSURANCE
    || value.independenceClaim !== CONTINUATION_V12_INDEPENDENCE_CLAIM
...
function validateExecutableRoots(policy, errors) {
  if (!Array.isArray(policy.continuationExecutables)
    || canonicalJsonV12(policy.continuationExecutables.map((entry) => entry?.kind))
      !== canonicalJsonV12(CONTINUATION_V12_EXECUTABLE_KINDS)) {
    errors.push("continuationExecutables must contain the exact ordered V12 kinds");
    return;
  }
  for (const [index, entry] of policy.continuationExecutables.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, ["kind", "path", "sha256"])
      || entry.path !== CONTINUATION_V12_EXECUTABLE_PATH_BY_KIND[entry.kind]
      || !repositoryPathV12(entry.path) || !sha256DigestV12(entry.sha256)) {
  ...
  if (canonicalJsonV12(actualSubset) !== canonicalJsonV12(expectedTrustRoots)) {
    errors.push("trustRoots do not bind every V12 transition and executable byte");
  }
}
...
function validateCallerDispatchSetShape(entries) {
  const errors = [];
  if (!Array.isArray(entries)
    || entries.length !== CONTINUATION_V12_REVIEW_LANES.length) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, DISPATCH_SET_ENTRY_KEYS)
      || entry.lane !== CONTINUATION_V12_REVIEW_LANES[index]
      || entry.assurance !== CONTINUATION_V12_CALLER_DISPATCH_ASSURANCE
      || entry.transport !== "codex-collaboration"
      || !sha256DigestV12(entry.challenge)
      || !sha256DigestV12(entry.instructionDigest)
...
function validateReviewReferences(entries, errors) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, REVIEW_REFERENCE_KEYS)
      ...
      || !repositoryPathV12(entry.path)
      || !sha256DigestV12(entry.challenge)
      || !sha256DigestV12(entry.canonicalDigest)) {
...
function validateFindings(receipt, errors) {
  ...
  if (canonicalJsonV12(actual) !== canonicalJsonV12(receipt.findingCounts)) {
...
function validatePathDigest(value, label, errors) {
  if (!plainObject(value)
    ...
    || !repositoryPathV12(value.path)
    || !sha256DigestV12(value.byteSha256)
    || !sha256DigestV12(value.canonicalDigest)) {
...
function validatePathSha(value, label, errors) {
  if (!plainObject(value) || !exactKeys(value, ["path", "sha256"])
    || !repositoryPathV12(value.path) || !sha256DigestV12(value.sha256)) {
    errors.push(`${label} is invalid`);
  }
}

function validateCanonicalDigest(value, label, errors) {
  if (!sha256DigestV12(value?.digest)) {
    errors.push(`${label} digest must be SHA-256`);
    return;
  }
  const withoutDigest = { ...value };
  delete withoutDigest.digest;
  if (hashCanonicalV12(withoutDigest) !== value.digest) {
...
function sameExactObject(actual, expected, keys) {
  return plainObject(actual)
    ...
    && canonicalJsonV12(actual) === canonicalJsonV12(expected);
}

function exactKeys(value, expected) {
  if (!plainObject(value)) return false;
  return canonicalJsonV12(Object.keys(value).sort())
    === canonicalJsonV12([...expected].sort());
}
...
function validateSortedUnique(values, label, errors) {
  ...
  if (new Set(values).size !== values.length
    || canonicalJsonV12(values) !== canonicalJsonV12(sorted)) {
    errors.push(`${label} must be sorted and unique`);
  }
}

function sameStringSet(left, right) {
  return canonicalJsonV12([...new Set(left)].sort())
    === canonicalJsonV12([...new Set(right)].sort());
}

function sameMap(left, right) {
  const project = (value) =>
    [...value.entries()].sort(([a], [b]) => a.localeCompare(b));
  return canonicalJsonV12(project(left)) === canonicalJsonV12(project(right));
}
...
export const canonicalJson = canonicalJsonV12;
export const hashCanonical = hashCanonicalV12;
export const sha256Bytes = sha256BytesV12;
export const validateRound11ReviewRejection = validateRound11ReviewRejectionV12;
export const validateAdmissionCoverage = validateAdmissionCoverageV12;
export const validateContinuationPolicy = validateContinuationPolicyV12;
export const validateBaselineArchive = validateBaselineArchiveV12;
export const validateReviewSnapshotV12 = validateContinuationReviewSnapshotV12;
export const validateReviewSnapshot = validateContinuationReviewSnapshotV12;
export const validateReviewReceiptV12 = validateContinuationReviewReceiptV12;
export const validateReviewSetV12 = validateContinuationReviewSetV12;
export const validateClosureManifestV12 = validateContinuationClosureManifestV12;
export const validateExternalAttestationV12 =
  validateContinuationExternalAttestationV12;
export const validateExternalAnchorV12 = validateContinuationExternalAnchorV12;
