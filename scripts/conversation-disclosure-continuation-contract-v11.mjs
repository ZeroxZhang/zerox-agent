...
export const CONTINUATION_V11_ALGORITHM = "sha256-canonical-json-v1";
export const CONTINUATION_V11_POLICY_KIND =
  "conversation-disclosure-continuation-policy";
export const CONTINUATION_V11_SNAPSHOT_KIND =
  "conversation-disclosure-continuation-review-snapshot";
export const CONTINUATION_V11_RECEIPT_KIND =
  "conversation-disclosure-continuation-review-receipt";
export const CONTINUATION_V11_MANIFEST_KIND =
  "conversation-disclosure-continuation-closure-manifest";
export const CONTINUATION_V11_ATTESTATION_KIND =
  "conversation-disclosure-continuation-external-attestation";
export const CONTINUATION_V11_ANCHOR_KIND =
  "conversation-disclosure-continuation-external-anchor";
export const CONTINUATION_V11_REVIEW_REJECTION_KIND =
  "conversation-disclosure-continuation-review-rejection";
export const CONTINUATION_V11_BASELINE_ARCHIVE_KIND =
  "conversation-disclosure-continuation-baseline-archive";

export const CONTINUATION_V11_POLICY_ID = "CD03A-round11-P108-admission-v11";
export const CONTINUATION_V11_WORKSTREAM_ID = "CD03A";
export const CONTINUATION_V11_FEATURE_ID =
  "P107A-conversation-disclosure-successor-admission";
export const CONTINUATION_V11_SUCCESSOR_WORKSTREAM_ID = "CD04";
export const CONTINUATION_V11_SUCCESSOR_FEATURE_ID =
  "P108-conversation-disclosure-evidence-foundation";
export const CONTINUATION_V11_ROUND = 11;
export const CONTINUATION_V11_REJECTED_ROUND = 10;

export const CONTINUATION_V11_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-successor-evolution-policy.json";
export const CONTINUATION_V11_BASELINE_ARCHIVE_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-baseline-archive.json";
export const CONTINUATION_V11_REVIEW_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-review-snapshot.json";
export const CONTINUATION_V11_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-closure-manifest.json";
export const CONTINUATION_V11_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round11-external-attestation.json";
export const CONTINUATION_V11_ROUND10_REVIEW_REJECTION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round10-review-rejection.json";

export const CONTINUATION_V11_ROUND10_POLICY_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round10-successor-evolution-policy.json";
export const CONTINUATION_V11_ROUND10_SNAPSHOT_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round10-review-snapshot.json";
export const CONTINUATION_V11_ROUND10_CLOSURE_MANIFEST_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round10-closure-manifest.json";
export const CONTINUATION_V11_ROUND10_EXTERNAL_ATTESTATION_PATH =
  ".zerox/verification/conversation-disclosure/CD03A-round10-external-attestation.json";

export const CONTINUATION_V11_REVIEW_LANES = Object.freeze([
  "contract", "runtime", "governance",
]);
export const CONTINUATION_V11_LIFECYCLE_PHASES = Object.freeze([
  "rejection_recorded",
  "policy_draft",
  "policy_published",
...
export const CONTINUATION_V11_LIFECYCLE_PROFILE_PHASES = Object.freeze([
  "review_pre_transition",
  "review_post_transition",
  "anchored_planned",
  "authorized_active",
]);
export const CONTINUATION_V11_EXECUTABLE_KINDS = Object.freeze([
  "checker", "contract", "freezer", "governance", "runner",
]);
export const CONTINUATION_V11_ADMISSION_CLASSES = Object.freeze([
  "frozen_file",
  "transition_live",
  "transition_payload",
  "post_review_mutable",
...
export const CONTINUATION_V11_ADMISSION_CLASS_SET_DIGEST =
  hashCanonicalV3(CONTINUATION_V11_ADMISSION_CLASSES);
export const CONTINUATION_V11_EXECUTABLE_PATH_BY_KIND = Object.freeze({
  checker: "scripts/check-conversation-disclosure-continuation-v11.mjs",
  contract: "scripts/conversation-disclosure-continuation-contract-v11.mjs",
  freezer: "scripts/freeze-conversation-disclosure-continuation-v11.mjs",
  governance: "scripts/conversation-disclosure-program-governance-v11.mjs",
  runner: "scripts/verify-conversation-disclosure-continuation-v11.mjs",
});
export const CONTINUATION_V11_GOVERNANCE_TRANSITIONS = Object.freeze({
...
export const CONTINUATION_V11_TARGET_PATH_BY_LIVE_PATH = Object.freeze({
  "package.json":
...
export const CONTINUATION_V11_GOVERNANCE_TRANSITION_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    path: "package.json",
    kind: CONTINUATION_V11_GOVERNANCE_TRANSITIONS["package.json"],
    fromSha256:
      "sha256:560fb3e3b2829a32b4ac694c7781fce9e53941a9e20fc4ec1c08602d53c278b9",
    stagedTargetPath: CONTINUATION_V11_TARGET_PATH_BY_LIVE_PATH["package.json"],
    toSha256:
      "sha256:a7e3b2b3baafc3d6d90b0ba1eae168be212096ea08b95d293fce15af5ca17d24",
  }),
  Object.freeze({
    path: "scripts/check-harness-state.mjs",
    kind: CONTINUATION_V11_GOVERNANCE_TRANSITIONS["scripts/check-harness-state.mjs"],
    fromSha256:
      "sha256:231d28280f6891f50f5c714b4161d1b9d93cf171e0b67396de67ce7a36e06339",
    stagedTargetPath:
      CONTINUATION_V11_TARGET_PATH_BY_LIVE_PATH["scripts/check-harness-state.mjs"],
    toSha256:
  ...
  Object.freeze({
    ...
    kind: CONTINUATION_V11_GOVERNANCE_TRANSITIONS[
      "src/shared/conversationDisclosureProgram.test.ts"
    ],
    fromSha256:
      "sha256:087cff0ba7f208464bf62e41f3a10dfbb88f3f2461d46398187c0b4cfa16dd5c",
    stagedTargetPath:
      CONTINUATION_V11_TARGET_PATH_BY_LIVE_PATH[
        "src/shared/conversationDisclosureProgram.test.ts"
      ],
    toSha256:
  ...
  Object.freeze({
    ...
    stagedTargetPath:
      CONTINUATION_V11_TARGET_PATH_BY_LIVE_PATH["src/shared/packageScripts.test.ts"],
    toSha256:
      "sha256:b72818d214355e31cec6af6ae8de65eb9866b2bac19a6a3ae8b76116e0c9ea06",
  }),
]);
export const CONTINUATION_V11_CALLER_DISPATCH_ASSURANCE =
  "caller-attested-not-signed";
export const CONTINUATION_V11_IDENTITY_ASSURANCE = "not-signed";
export const CONTINUATION_V11_INDEPENDENCE_CLAIM =
  "caller-attested-distinct-review-contexts";
export const CONTINUATION_V11_CANDIDATE_RESULT_KINDS = Object.freeze([
  "checker",
  "harness",
]);
export const CONTINUATION_V11_CANDIDATE_PATH_BY_KIND = Object.freeze({
  checker: CONTINUATION_V11_EXECUTABLE_PATH_BY_KIND.checker,
  harness: "scripts/check-harness-state.mjs",
});

export const CONTINUATION_V11_ROUND10_POLICY_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V11_ROUND10_POLICY_PATH,
  byteSha256: "sha256:da93a0009687aa8e4d98f113e66f78fec97135c99ba546a06d980fcddd39decc",
  canonicalDigest: "sha256:9af3527a914ded769665cf7f23240f37782dfb6b6195b94eaccd2163ef9f2814",
});
export const CONTINUATION_V11_ROUND10_SNAPSHOT_TRUST_ROOT = Object.freeze({
  path: CONTINUATION_V11_ROUND10_SNAPSHOT_PATH,
  byteSha256: "sha256:ee070490565b0394decee407837c4b473b1fe81561e2b29760ab25feda60456f",
  canonicalDigest: "sha256:138f00e1e7621cdb6aabb581e8f3c55efbebfe4eeb621689815cf387b7025eec",
  frozenFileCount: 293,
  transitionPayloadFileCount: 4,
  baselineFileCount: 12,
});

export const CONTINUATION_V11_ROUND10_RECEIPT_TRUST_ROOTS = Object.freeze([
  Object.freeze({
    lane: "contract",
    path: ".zerox/verification/conversation-disclosure/CD03A-round10-contract-review.json",
    byteSha256: "sha256:f6dacda97270a505f7d3fd9a951d6a87d34efa15308a04b44aaa89c66165feb3",
    canonicalDigest: "sha256:9021e9ade6028cb7c7a05731c7f1bc945826bd2860803ede8413ec9257d4479f",
    challenge: "sha256:f6f14d9a5eb522bc0eb4936295d9994becf4fedc89624a98ab7eb419b7ce9660",
    verdict: "failed",
    findingCounts: Object.freeze({ critical: 0, major: 1, minor: 0 }),
  }),
]);

export const CONTINUATION_V11_ROUND10_FINDING_IDS = Object.freeze([
  "R10-CONTRACT-001",
]);
export const CONTINUATION_V11_ROUND10_FINDING_SET_DIGEST =
  "sha256:1d1568105e054964ae0fcf7f5e01c17a8bc8ba8610f1c4a5154c4ac91323bd07";
export const CONTINUATION_V11_ROUND10_AGGREGATE_FINDING_COUNTS = Object.freeze({
  critical: 0,
  major: 1,
  minor: 0,
});
export const CONTINUATION_V11_ROUND1_REJECTION_DIGEST =
  "sha256:ec981e92f486ae75a56b3b4b393f95d095f6d684e6af54fe12cc7a9ba0fe1f99";
export const CONTINUATION_V11_ROUND2_REJECTION_TRUST_ROOT = Object.freeze({
...
export const CONTINUATION_V11_ROUND10_REPOSITORY_FORBIDDEN_OUTPUT_PATHS =
  Object.freeze([
    ".zerox/verification/conversation-disclosure/CD03A-round10-governance-review.json",
    ".zerox/verification/conversation-disclosure/CD03A-round10-runtime-review.json",
    CONTINUATION_V11_ROUND10_CLOSURE_MANIFEST_PATH,
    CONTINUATION_V11_ROUND10_EXTERNAL_ATTESTATION_PATH,
  ].sort());
export const CONTINUATION_V11_ROUND1_REPOSITORY_FORBIDDEN_OUTPUT_PATHS =
  Object.freeze([...CONTINUATION_V2_ROUND1_FORBIDDEN_OUTPUT_PATHS].sort());
export const CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS = Object.freeze([
  ...new Set([
    ...CONTINUATION_V2_ROUND1_FORBIDDEN_OUTPUT_PATHS,
    ...CONTINUATION_V10_REJECTED_OUTPUT_ABSENT_PATHS,
...
export const CONTINUATION_V11_REVIEW_OUTPUT_PATHS = Object.freeze([
  CONTINUATION_V11_REVIEW_SNAPSHOT_PATH,
  ...CONTINUATION_V11_REVIEW_LANES.map((lane) =>
...
export const CONTINUATION_V11_RUNTIME_IO_INTERFACE = Object.freeze({
  schemaVersion: 1,
...
const ROUND10_REJECTION_KEYS = Object.freeze([
...
export const CONTINUATION_V11_POLICY_KEYS = POLICY_KEYS;
export const CONTINUATION_V11_SNAPSHOT_KEYS = SNAPSHOT_KEYS;
export const CONTINUATION_V11_BASELINE_ARCHIVE_KEYS = ARCHIVE_KEYS;
export const CONTINUATION_V11_REVIEW_REJECTION_KEYS = ROUND10_REJECTION_KEYS;
export const CONTINUATION_V11_RECEIPT_KEYS = RECEIPT_KEYS;
export const CONTINUATION_V11_MANIFEST_KEYS = MANIFEST_KEYS;

export const canonicalJsonV11 = canonicalJsonV3;
export const hashCanonicalV11 = hashCanonicalV3;
export const sha256BytesV11 = sha256BytesV3;
export const sha256DigestV11 = sha256DigestV3;
export const repositoryPathV11 = repositoryPathV3;
export const withCanonicalDigestV11 = withCanonicalDigestV3;
export const stableFeatureDefinitionV11 = stableFeatureDefinitionV3;
export const stableHistoricalFeatureDefinitionV11 =
  stableHistoricalFeatureDefinitionV3;
export const stableProgramRootDefinitionV11 = stableProgramRootDefinitionV3;
export const stableWorkstreamDefinitionV11 = stableWorkstreamDefinitionV3;

export function buildAdmissionCoverageV11(
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS,
) {
  const files = admission?.featureDefinition?.files;
  if (!Array.isArray(files) || files.length === 0
    || new Set(files).size !== files.length
    || files.some((entry) => !repositoryPathV11(entry))) {
    throw new TypeError("P107A exact V11 file roster is invalid");
  }
  if (canonicalJsonV11(rejectedOutputAbsentPaths)
    !== canonicalJsonV11(CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS)) {
    throw new TypeError("V11 rejected-output absence roster is not exact");
  }
  const byClass = new Map(CONTINUATION_V11_ADMISSION_CLASSES.map((entry) => [
    entry,
    new Set(),
  ]));
  ...
  return files.map((relativePath) => {
    const classes = CONTINUATION_V11_ADMISSION_CLASSES.filter((entry) =>
      entry !== "frozen_file" && byClass.get(entry).has(relativePath));
    if (classes.length > 1) {
      throw new TypeError(`V11 path has overlapping admission classes: ${relativePath}`);
    }
    return { path: relativePath, class: classes[0] ?? "frozen_file" };
  }).sort(comparePath);
}

export function validateAdmissionCoverageV11(
  coverage,
  admission,
  transitions,
  rejectedOutputAbsentPaths = CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS,
  ...
  for (const [index, entry] of coverage.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, COVERAGE_KEYS)
      || !repositoryPathV11(entry.path)
      || !CONTINUATION_V11_ADMISSION_CLASSES.includes(entry.class)) {
  ...
  let expected;
  try {
    expected = buildAdmissionCoverageV11(
      admission,
      transitions,
  ...
  if (expected && canonicalJsonV11(coverage) !== canonicalJsonV11(expected)) {
    errors.push("admissionCoverage differs from the exact V11 classification");
  }
  ...
  for (const requiredClass of CONTINUATION_V11_ADMISSION_CLASSES) {
...
export function validateRound10ReviewRejectionV11(witness) {
  const errors = [];
  if (!plainObject(witness) || !exactKeys(witness, ROUND10_REJECTION_KEYS)) {
    return ["Round10 review rejection must contain the exact V11 keys"];
  }
  if (witness.schemaVersion !== 11
    || witness.kind !== CONTINUATION_V11_REVIEW_REJECTION_KIND
    || witness.algorithm !== CONTINUATION_V11_ALGORITHM
    || witness.workstreamId !== CONTINUATION_V11_WORKSTREAM_ID
    || witness.featureId !== CONTINUATION_V11_FEATURE_ID
    || witness.rejectedRound !== CONTINUATION_V11_REJECTED_ROUND
    || witness.recoveryRound !== CONTINUATION_V11_ROUND
    || witness.status !== "rejected_after_review"
    || !nonEmpty(witness.programId)) {
    errors.push("Round10 review rejection identity/status is invalid");
  }
  if (!sameExactObject(witness.sourcePolicy,
    CONTINUATION_V11_ROUND10_POLICY_TRUST_ROOT, POLICY_REFERENCE_KEYS)) {
    errors.push("Round10 policy reference differs from both hard trust roots");
  }
  if (!sameExactObject(witness.sourceSnapshot,
    CONTINUATION_V11_ROUND10_SNAPSHOT_TRUST_ROOT, SNAPSHOT_REFERENCE_KEYS)) {
    errors.push("Round10 snapshot reference differs from both hard trust roots");
  }
  validateCompletedReceiptReferences(witness.completedReceipts, errors);
  if (!sameExactObject(witness.aggregateFindingCounts,
    CONTINUATION_V11_ROUND10_AGGREGATE_FINDING_COUNTS, FINDING_COUNT_KEYS)) {
    errors.push("Round10 aggregate finding counts differ from the completed receipts");
  }
  if (canonicalJsonV11(witness.findingIds)
    !== canonicalJsonV11(CONTINUATION_V11_ROUND10_FINDING_IDS)
    || witness.findingSetDigest !== CONTINUATION_V11_ROUND10_FINDING_SET_DIGEST) {
    errors.push("Round10 finding set differs from the hard rejection root");
  }
  if (canonicalJsonV11(witness.repositoryForbiddenOutputs)
    !== canonicalJsonV11(CONTINUATION_V11_ROUND10_REPOSITORY_FORBIDDEN_OUTPUT_PATHS)) {
    errors.push("Round10 repository forbidden-output set is not exact");
  }
  const expectedAnchorRule = expectedRejectedRound10AnchorRuleV11();
  if (!sameExactObject(witness.externalAnchorRule, expectedAnchorRule,
    EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("Round10 external anchor rule is invalid or asserts fictional absence");
  }
  const expectedPrior = {
    round1CanonicalDigest: CONTINUATION_V11_ROUND1_REJECTION_DIGEST,
    round2: CONTINUATION_V11_ROUND2_REJECTION_TRUST_ROOT,
  };
  if (!plainObject(witness.priorRejections)
    ...
    errors.push("Round10 rejection does not bind the exact prior rejection chain");
  }
  validateCanonicalDigest(witness, "Round10 review rejection", errors);
  return unique(errors);
}

export function expectedRejectedRound10AnchorRuleV11() {
  return {
    policyDigest: CONTINUATION_V11_ROUND10_POLICY_TRUST_ROOT.canonicalDigest,
    snapshotDigest: CONTINUATION_V11_ROUND10_SNAPSHOT_TRUST_ROOT.canonicalDigest,
    admissibility: "forbidden",
    externalAbsenceClaim: "not_asserted",
  };
}

export function validateRejectedRound10AnchorSubjectV11(anchor) {
  if (!plainObject(anchor)) return ["external anchor candidate must be an object"];
  if (anchor.policyDigest === CONTINUATION_V11_ROUND10_POLICY_TRUST_ROOT.canonicalDigest
    && anchor.snapshotDigest
      === CONTINUATION_V11_ROUND10_SNAPSHOT_TRUST_ROOT.canonicalDigest) {
    return ["external anchor is bound to the rejected Round10 subject"];
  }
  return [];
}

export function validateRejectedOutputAbsenceCapturesV11(captures) {
  const errors = [];
  if (!Array.isArray(captures)) return ["absence captures must be an array"];
  const expected = CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS.map((entry) => ({
    path: entry,
    presence: "absent",
  }));
  for (const [index, capture] of captures.entries()) {
    if (!plainObject(capture)
      ...
      || !repositoryPathV11(capture.path)
      || capture.presence !== "absent") {
      errors.push(`absence capture[${index}] is invalid`);
    }
  }
  if (canonicalJsonV11(captures) !== canonicalJsonV11(expected)) {
    errors.push("absence captures differ from the exact rejected-output roster");
  }
  return unique(errors);
}

export function validateRuntimeIoCaptureAdapterV11(adapter) {
  if (adapter === null || (typeof adapter !== "object"
    && typeof adapter !== "function")) {
    return ["runtime I/O adapter must be an object"];
  }
  return CONTINUATION_V11_RUNTIME_IO_INTERFACE.methods
    .filter((method) => typeof adapter[method] !== "function")
    .map((method) => `runtime I/O adapter misses ${method}`);
}

export function validateContinuationPolicyV11(policy, bindings = {}) {
  const errors = [];
  if (!plainObject(policy) || !exactKeys(policy, POLICY_KEYS)) {
    return ["continuation policy must contain the exact V11 keys"];
  }
  if (policy.schemaVersion !== 11
    || policy.kind !== CONTINUATION_V11_POLICY_KIND
    || policy.algorithm !== CONTINUATION_V11_ALGORITHM
    || policy.policyId !== CONTINUATION_V11_POLICY_ID
    || policy.workstreamId !== CONTINUATION_V11_WORKSTREAM_ID
    || policy.featureId !== CONTINUATION_V11_FEATURE_ID
    || policy.round !== CONTINUATION_V11_ROUND
    || policy.status !== "frozen"
    || !nonEmpty(policy.programId)) {
    errors.push("continuation policy V11 identity/status is invalid");
  }
  if (canonicalJsonV11(policy.admissionClassSet)
      !== canonicalJsonV11(CONTINUATION_V11_ADMISSION_CLASSES)
  ...
  errors.push(...validateRound10ReviewRejectionV11(policy.round10ReviewRejection));
  if (policy.round10ReviewRejection?.programId !== policy.programId) {
    errors.push("Round10 rejection programId differs from the continuation policy");
  }
  errors.push(...validateAdmissionDefinitionV2(policy.admission));
  errors.push(...validateAdmissionCoverageV11(
  ...
  if (canonicalJsonV11(policy.governanceTransitions)
    !== canonicalJsonV11(CONTINUATION_V11_GOVERNANCE_TRANSITION_TRUST_ROOTS)) {
    errors.push("V11 governance transitions differ from the Round11 target trust root");
  }
  ...
  if (!sameExactObject(policy.externalAnchorPolicy,
    expectedRejectedRound10AnchorRuleV11(), EXTERNAL_ANCHOR_RULE_KEYS)) {
    errors.push("policy externalAnchorPolicy does not forbid the rejected Round10 subject");
  }
  if (!plainObject(policy.reviewSnapshot)
    || !exactKeys(policy.reviewSnapshot, ["path"])
    || policy.reviewSnapshot.path !== CONTINUATION_V11_REVIEW_SNAPSHOT_PATH) {
    errors.push("policy reviewSnapshot path is invalid");
  }
  validateBaselineArchiveReferenceV11(
  ...
  if (canonicalJsonV11(rejectedCoverage)
    !== canonicalJsonV11(CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS)) {
  ...
  if (bindings.expectedAdmissionRoots !== undefined) {
    ...
    if (!plainObject(roots)
      ...
      for (const [key, actual] of [
        ...
        if (!sha256DigestV11(roots[key]) || roots[key] !== actual) {
  ...
  if (bindings.baselineArchive !== undefined) {
    errors.push(...validateBaselineArchiveV11(bindings.baselineArchive, policy));
  }
  if (bindings.lifecycleState !== undefined) {
    errors.push(...validateLifecycleStateV11(bindings.lifecycleState, policy));
  }
  return unique(errors);
}

export function validateBaselineArchiveV11(archive, policy) {
  const errors = [];
  if (!plainObject(archive) || !exactKeys(archive, ARCHIVE_KEYS)) {
    return ["baseline archive must contain the exact V11 keys"];
  }
  if (archive.schemaVersion !== 11
    || archive.kind !== CONTINUATION_V11_BASELINE_ARCHIVE_KIND
    || archive.algorithm !== CONTINUATION_V11_ALGORITHM
    || archive.workstreamId !== CONTINUATION_V11_WORKSTREAM_ID
    || archive.featureId !== CONTINUATION_V11_FEATURE_ID
    || archive.round !== CONTINUATION_V11_ROUND
    || !nonEmpty(archive.programId)) {
    errors.push("baseline archive V11 identity is invalid");
  }
  ...
  for (const [index, entry] of (archive.entries ?? []).entries()) {
    ...
    try {
      ...
      if (sha256BytesV11(decoded) !== entry.sha256) throw new Error("digest");
    } catch {
  ...
  if (plainObject(policy)) {
    ...
    if (canonicalJsonV11(actual) !== canonicalJsonV11(expected)) {
...
export function validateContinuationReviewSnapshotV11(
  snapshot,
  policy,
  bindings = {},
) {
  ...
  if (!plainObject(snapshot) || !exactKeys(snapshot, SNAPSHOT_KEYS)) {
    return ["continuation review snapshot must contain the exact V11 keys"];
  }
  if (snapshot.schemaVersion !== 11
    || snapshot.kind !== CONTINUATION_V11_SNAPSHOT_KIND
    || snapshot.algorithm !== CONTINUATION_V11_ALGORITHM
    || snapshot.workstreamId !== CONTINUATION_V11_WORKSTREAM_ID
    || snapshot.featureId !== CONTINUATION_V11_FEATURE_ID
    || snapshot.round !== CONTINUATION_V11_ROUND
    || !nonEmpty(snapshot.programId)) {
    errors.push("continuation review snapshot V11 identity is invalid");
  }
  validateTimestampV11(
    snapshot.frozenAt,
  ...
  ]) validateFileDigestArrayV11(snapshot[key], label, errors);
  validateStringPathsV11(snapshot.absentPaths, "snapshot absentPaths", errors);
  validateStringPathsV11(
  ...
  if (plainObject(policy)) {
    ...
    if (canonicalJsonV11(snapshot.governanceTransitions)
      !== canonicalJsonV11(policy.governanceTransitions)) {
      errors.push("snapshot governance transitions differ from policy");
    }
    if (canonicalJsonV11(snapshot.baselineArchive)
      !== canonicalJsonV11(policy.baselineArchive)) {
      errors.push("snapshot baselineArchive differs from policy");
    }
    validateSnapshotAdmissionSubjectsV11(snapshot, policy, errors);
    validateSnapshotAuthoritySubjectsV11(snapshot, policy, errors);
  }
  validateCanonicalDigest(snapshot, "continuation review snapshot", errors);
  return unique(errors);
}

export function validateGovernanceTransitionStateV11(
  transitions,
  phase,
  liveDigests,
  stagedDigests,
  ...
  if (canonicalJsonV11(pathKinds)
    !== canonicalJsonV11(CONTINUATION_V11_GOVERNANCE_TRANSITIONS)) {
    errors.push("V11 governance transition path/kind set is not exact");
  }
...
export function validateLifecycleStateV11(live, policy) {
  return validateLifecycleStateV2(live, policy);
}

export function selectLifecycleProfileV11(policy, phase) {
  if (!CONTINUATION_V11_LIFECYCLE_PROFILE_PHASES.includes(phase)) {
    return undefined;
  }
...
export function validateContinuationReviewReceiptV11(
  receipt,
  snapshot,
  policy,
  bindings = {},
  ...
  if (!plainObject(receipt) || !exactKeys(receipt, RECEIPT_KEYS)) {
    return ["continuation review receipt must contain the exact V11 keys"];
  }
  if (receipt.schemaVersion !== 11
    || receipt.kind !== CONTINUATION_V11_RECEIPT_KIND
    || receipt.workstreamId !== CONTINUATION_V11_WORKSTREAM_ID
    || receipt.featureId !== CONTINUATION_V11_FEATURE_ID
    || receipt.round !== CONTINUATION_V11_ROUND
    || !CONTINUATION_V11_REVIEW_LANES.includes(receipt.lane)
    || receipt.reviewedPhase !== "review_pre_transition"
    || receipt.identityAssurance !== CONTINUATION_V11_IDENTITY_ASSURANCE
    || receipt.independenceClaim !== CONTINUATION_V11_INDEPENDENCE_CLAIM
    || !nonEmpty(receipt.programId)) {
    errors.push("continuation review receipt V11 identity/assurance is invalid");
  }
  ...
  for (const key of [
    ...
    if (!sha256DigestV11(receipt[key])) errors.push(`receipt ${key} must be SHA-256`);
  }
  validateFindings(receipt, errors);
  const completedAt = validateTimestampV11(
    receipt.completedAt,
    bindings.verifierNow,
    "receipt completedAt",
    errors,
  ...
  if (plainObject(snapshot) && plainObject(policy)) {
    ...
    const validator = policy.continuationExecutables?.find(
      (entry) => entry?.kind === "checker"
        && entry?.path === CONTINUATION_V11_EXECUTABLE_PATH_BY_KIND.checker,
    );
    const expected = {
      programId: policy.programId,
...
export function validateContinuationReviewSetV11(
  receipts,
  callerDispatchSet,
  snapshot,
  policy,
  ...
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V11_REVIEW_LANES.length
    || !Array.isArray(callerDispatchSet)
    || callerDispatchSet.length !== CONTINUATION_V11_REVIEW_LANES.length) {
    return ["V11 review set requires exactly three receipts and dispatch-set entries"];
  }
  const contextIds = [];
  const dispatchSetDigest = hashCanonicalV11(callerDispatchSet);
  for (let index = 0; index < CONTINUATION_V11_REVIEW_LANES.length; index += 1) {
    const lane = CONTINUATION_V11_REVIEW_LANES[index];
    const receipt = receipts[index];
    const caller = callerDispatchSet[index];
    if (!plainObject(caller) || !exactKeys(caller, DISPATCH_SET_ENTRY_KEYS)
      || caller.lane !== lane
      || caller.assurance !== CONTINUATION_V11_CALLER_DISPATCH_ASSURANCE
      || caller.transport !== "codex-collaboration"
      || !sha256DigestV11(caller.challenge)
      || !sha256DigestV11(caller.instructionDigest)
    ...
    errors.push(...validateContinuationReviewReceiptV11(receipt, snapshot, policy, {
      callerPin: {
        challenge: caller.challenge,
        dispatchEntryDigest: hashCanonicalV11(caller),
        dispatchSetDigest,
      },
  ...
  if (new Set(contextIds).size !== CONTINUATION_V11_REVIEW_LANES.length) {
    errors.push("caller must attest three distinct reviewContextId values");
  }
  return unique(errors);
}

export function validateContinuationClosureManifestV11(manifest, bindings = {}) {
  const errors = [];
  if (!plainObject(manifest) || !exactKeys(manifest, MANIFEST_KEYS)) {
    return ["continuation closure manifest must contain the exact V11 keys"];
  }
  if (manifest.schemaVersion !== 11
    || manifest.kind !== CONTINUATION_V11_MANIFEST_KIND
    || manifest.workstreamId !== CONTINUATION_V11_WORKSTREAM_ID
    || manifest.featureId !== CONTINUATION_V11_FEATURE_ID
    || manifest.round !== CONTINUATION_V11_ROUND
    || !["review_passed_pending_external_transaction", "externally_attested"]
      .includes(manifest.status)) {
    errors.push("continuation closure manifest V11 identity/status is invalid");
  }
  ...
  validatePathDigest(manifest.round10ReviewRejection,
    "manifest Round10 rejection", errors);
  ...
  if (manifest.policy?.path !== CONTINUATION_V11_POLICY_PATH
    || manifest.snapshot?.path !== CONTINUATION_V11_REVIEW_SNAPSHOT_PATH
    || manifest.round10ReviewRejection?.path
      !== CONTINUATION_V11_ROUND10_REVIEW_REJECTION_PATH
    || manifest.validator?.path
      !== CONTINUATION_V11_EXECUTABLE_PATH_BY_KIND.checker
    || manifest.externalRunner?.path
      !== CONTINUATION_V11_EXECUTABLE_PATH_BY_KIND.runner) {
    errors.push("manifest evidence paths differ from canonical Round11 roots");
  }
  ...
  if (!sha256DigestV11(manifest.parentEvidenceBundleDigest)
    || !sha256DigestV11(manifest.pendingManifestDigest)) {
    errors.push("manifest parent/pending digest is invalid");
  }
  if (manifest.pendingManifestDigest !== pendingManifestDigestV11(manifest)) {
  ...
  if (!plainObject(manifest.externalAttestation)
    ...
    || (manifest.status === "review_passed_pending_external_transaction"
      ...
      : !sha256DigestV11(manifest.externalAttestation.canonicalDigest))) {
    errors.push("manifest external attestation reference is invalid");
  }
  if (plainObject(bindings.policy)
    && (manifest.policy?.canonicalDigest !== bindings.policy.digest
      || manifest.round10ReviewRejection?.canonicalDigest
        !== bindings.policy.round10ReviewRejection?.digest)) {
  ...
  if (manifest.status === "externally_attested") {
    if (!plainObject(bindings.pendingManifest)
      ...
      || canonicalJsonV11(finalManifestProjectionV11(
        bindings.pendingManifest,
        bindings.externalAttestation.digest,
      )) !== canonicalJsonV11(withoutDigestV11(manifest))) {
...
export function pendingManifestDigestV11(manifest) {
...
export function finalManifestProjectionV11(pendingManifest, attestationDigest) {
  const projected = withoutDigestV11(pendingManifest);
...
export function validateContinuationExternalAttestationV11(
  attestation,
  bindings = {},
) {
  const errors = [];
  if (!plainObject(attestation) || !exactKeys(attestation, ATTESTATION_KEYS)) {
    return ["external attestation must contain the exact V11 keys"];
  }
  if (attestation.schemaVersion !== 11
    || attestation.kind !== CONTINUATION_V11_ATTESTATION_KIND
    || attestation.status !== "passed"
    || attestation.governancePhase !== "review_post_transition"
    || attestation.identityAssurance !== CONTINUATION_V11_IDENTITY_ASSURANCE
    || attestation.reviewAssurance !== CONTINUATION_V11_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(attestation.repositoryRealpath)) {
    errors.push("external attestation V11 identity/assurance is invalid");
  }
  for (const key of [
    "parentEvidenceBundleDigest", "pendingManifestDigest", "policyDigest",
    "round10ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV11(attestation[key])) errors.push(`attestation ${key} is invalid`);
  errors.push(...validateCallerDispatchSetShape(attestation.callerDispatchSet));
  validateCandidateResultsV11(
  ...
  if (!plainObject(bindings.policy)
    ...
    || !plainObject(bindings.round10ReviewRejection)
    ...
    const expected = {
      ...
      round10ReviewRejectionDigest: bindings.round10ReviewRejection.digest,
    ...
    if (canonicalJsonV11(attestation.callerDispatchSet)
      !== canonicalJsonV11(bindings.callerDispatchSet)) {
      errors.push("external attestation dispatch binding is stale");
    }
    if (canonicalJsonV11(attestation.candidateResults)
      !== canonicalJsonV11(bindings.candidateResults)) {
...
export function validateContinuationExternalAnchorV11(anchor, bindings = {}) {
  const errors = [];
  if (!plainObject(anchor) || !exactKeys(anchor, ANCHOR_KEYS)) {
    return ["external anchor must contain the exact V11 keys"];
  }
  if (anchor.schemaVersion !== 11
    || anchor.kind !== CONTINUATION_V11_ANCHOR_KIND
    || anchor.identityAssurance !== CONTINUATION_V11_IDENTITY_ASSURANCE
    || anchor.reviewAssurance !== CONTINUATION_V11_CALLER_DISPATCH_ASSURANCE
    || !path.isAbsolute(anchor.repositoryRealpath)) {
    errors.push("external anchor V11 identity/assurance is invalid");
  }
  for (const key of [
    "attestationDigest", "parentEvidenceBundleDigest", "policyDigest",
    "round10ReviewRejectionDigest", "runnerDigest", "snapshotDigest", "validatorDigest",
  ]) if (!sha256DigestV11(anchor[key])) errors.push(`anchor ${key} is invalid`);
  errors.push(...validateCallerDispatchSetShape(anchor.callerDispatchSet));
  validateCandidateResultsV11(anchor.candidateResults, bindings.policy, errors);
  ...
  if (!plainObject(bindings.attestation)
    ...
    if (canonicalJsonV11(anchor.callerDispatchSet)
      !== canonicalJsonV11(bindings.callerDispatchSet)) {
      errors.push("external anchor dispatch binding is stale");
    }
    if (canonicalJsonV11(anchor.candidateResults)
      !== canonicalJsonV11(bindings.attestation.candidateResults)) {
    ...
    if (canonicalJsonV11(anchor.head) !== canonicalJsonV11(expectedHead)) {
      errors.push("external anchor head is not the exact P107A successor-admission head");
    }
  }
  errors.push(...validateRejectedRound10AnchorSubjectV11(anchor));
...
export function serializeRound10ReviewRejectionV11(witness) {
  const errors = validateRound10ReviewRejectionV11(witness);
  if (errors.length > 0) throw new TypeError(errors.join("; "));
  return Buffer.from(`${JSON.stringify(witness, null, 2)}\n`, "utf8");
}

function validateCandidateResultsV11(results, policy, errors) {
  if (!Array.isArray(results)
    || results.length !== CONTINUATION_V11_CANDIDATE_RESULT_KINDS.length) {
  ...
  const expectedPaths = {
    ...CONTINUATION_V11_CANDIDATE_PATH_BY_KIND,
    checker: policyCheckerPath
      ?? CONTINUATION_V11_CANDIDATE_PATH_BY_KIND.checker,
  };
  for (let index = 0;
    index < CONTINUATION_V11_CANDIDATE_RESULT_KINDS.length;
    index += 1) {
    const result = results[index];
    const kind = CONTINUATION_V11_CANDIDATE_RESULT_KINDS[index];
    if (!plainObject(result)
      || !exactKeys(result, CANDIDATE_RESULT_KEYS)
      || result.kind !== kind
      || result.path !== expectedPaths[kind]
      || result.status !== "passed"
      || !sha256DigestV11(result.receiptDigest)
      || !sha256DigestV11(result.stdoutDigest)
      || !sha256DigestV11(result.stderrDigest)) {
      errors.push(`attestation candidateResults[${index}] is not exact ${kind} PASS evidence`);
    }
  }
}

function withoutDigestV11(value) {
  const projected = structuredClone(value);
  delete projected.digest;
  return projected;
}

function validateSnapshotAdmissionSubjectsV11(snapshot, policy, errors) {
  const byClass = new Map(
    CONTINUATION_V11_ADMISSION_CLASSES.map((value) => [value, []]),
  );
  ...
  for (const reference of [
    ...
    if (frozen.get(reference.path) !== reference.byteSha256) {
      errors.push(`snapshot does not freeze Round10 rejection evidence: ${reference.path}`);
    }
  }
  const rejectionBytes = sha256BytesV11(
    serializeRound10ReviewRejectionV11(policy.round10ReviewRejection),
  );
  if (frozen.get(CONTINUATION_V11_ROUND10_REVIEW_REJECTION_PATH)
    !== rejectionBytes) {
    errors.push("snapshot does not freeze exact Round10 review-rejection bytes");
  }
}

function validateSnapshotAuthoritySubjectsV11(snapshot, policy, errors) {
  const baseline = new Map((snapshot.baselineFiles ?? [])
    .map((entry) => [entry.path, entry.sha256]));
  const absent = new Set(snapshot.absentPaths ?? []);
  const expectedBaseline = new Map();
  const expectedAbsent = new Set(CONTINUATION_V11_REJECTED_OUTPUT_ABSENT_PATHS);
  for (const authority of policy.pathAuthorities ?? []) {
    if (authority.class === "modify"
  ...
  if (!sameMap(baseline, expectedBaseline)) {
    errors.push("snapshot baselineFiles do not exactly bind V11 baselines");
  }
...
function validateBaselineArchiveReferenceV11(reference, subject, errors) {
  if (!plainObject(reference)
    || !exactKeys(reference, ["digest", "entrySetDigest", "path"])
    || reference.path !== CONTINUATION_V11_BASELINE_ARCHIVE_PATH
    || !sha256DigestV11(reference.digest)
    || !sha256DigestV11(reference.entrySetDigest)) {
    errors.push(`${subject} is invalid`);
  }
}

function validateFileDigestArrayV11(entries, subject, errors) {
  ...
  for (const [index, entry] of entries.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, FILE_DIGEST_KEYS)
      || !repositoryPathV11(entry.path) || !sha256DigestV11(entry.sha256)) {
...
function validateStringPathsV11(entries, subject, errors) {
  if (!Array.isArray(entries)) {
    errors.push(`${subject} must be an array`);
    return;
  }
  if (entries.some((entry) => !repositoryPathV11(entry))) {
    errors.push(`${subject} contains an invalid path`);
  }
  validateSortedUnique(entries, subject, errors);
}

function validateTimestampV11(value, verifierNow, subject, errors) {
...
function validateCompletedReceiptReferences(receipts, errors) {
  if (!Array.isArray(receipts)
    || receipts.length !== CONTINUATION_V11_ROUND10_RECEIPT_TRUST_ROOTS.length) {
    errors.push("Round10 rejection must bind every completed review receipt");
    return;
  }
  for (let index = 0; index < receipts.length; index += 1) {
    ...
    if (!plainObject(actual) || !exactKeys(actual, COMPLETED_RECEIPT_REFERENCE_KEYS)
      ...
      || !sameExactObject(actual.findingCounts, expected.findingCounts,
        FINDING_COUNT_KEYS)) {
      errors.push(`Round10 completed receipt root differs for lane ${expected.lane}`);
    }
  }
}
...
function validateReviewAssurancePolicy(value, errors) {
  ...
  if (!plainObject(value) || !exactKeys(value, keys)
    || value.callerDispatchAssurance !== CONTINUATION_V11_CALLER_DISPATCH_ASSURANCE
    || value.identityAssurance !== CONTINUATION_V11_IDENTITY_ASSURANCE
    || value.independenceClaim !== CONTINUATION_V11_INDEPENDENCE_CLAIM
...
function validateExecutableRoots(policy, errors) {
  if (!Array.isArray(policy.continuationExecutables)
    || canonicalJsonV11(policy.continuationExecutables.map((entry) => entry?.kind))
      !== canonicalJsonV11(CONTINUATION_V11_EXECUTABLE_KINDS)) {
    errors.push("continuationExecutables must contain the exact ordered V11 kinds");
    return;
  }
  for (const [index, entry] of policy.continuationExecutables.entries()) {
    if (!plainObject(entry) || !exactKeys(entry, ["kind", "path", "sha256"])
      || entry.path !== CONTINUATION_V11_EXECUTABLE_PATH_BY_KIND[entry.kind]
      || !repositoryPathV11(entry.path) || !sha256DigestV11(entry.sha256)) {
  ...
  if (canonicalJsonV11(actualSubset) !== canonicalJsonV11(expectedTrustRoots)) {
    errors.push("trustRoots do not bind every V11 transition and executable byte");
  }
}
...
function validateCallerDispatchSetShape(entries) {
  const errors = [];
  if (!Array.isArray(entries)
    || entries.length !== CONTINUATION_V11_REVIEW_LANES.length) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, DISPATCH_SET_ENTRY_KEYS)
      || entry.lane !== CONTINUATION_V11_REVIEW_LANES[index]
      || entry.assurance !== CONTINUATION_V11_CALLER_DISPATCH_ASSURANCE
      || entry.transport !== "codex-collaboration"
      || !sha256DigestV11(entry.challenge)
      || !sha256DigestV11(entry.instructionDigest)
...
function validateReviewReferences(entries, errors) {
  ...
  for (let index = 0; index < entries.length; index += 1) {
    ...
    if (!plainObject(entry) || !exactKeys(entry, REVIEW_REFERENCE_KEYS)
      ...
      || !repositoryPathV11(entry.path)
      || !sha256DigestV11(entry.challenge)
      || !sha256DigestV11(entry.canonicalDigest)) {
...
function validateFindings(receipt, errors) {
  ...
  if (canonicalJsonV11(actual) !== canonicalJsonV11(receipt.findingCounts)) {
...
function validatePathDigest(value, label, errors) {
  if (!plainObject(value)
    ...
    || !repositoryPathV11(value.path)
    || !sha256DigestV11(value.byteSha256)
    || !sha256DigestV11(value.canonicalDigest)) {
...
function validatePathSha(value, label, errors) {
  if (!plainObject(value) || !exactKeys(value, ["path", "sha256"])
    || !repositoryPathV11(value.path) || !sha256DigestV11(value.sha256)) {
    errors.push(`${label} is invalid`);
  }
}

function validateCanonicalDigest(value, label, errors) {
  if (!sha256DigestV11(value?.digest)) {
    errors.push(`${label} digest must be SHA-256`);
    return;
  }
  const withoutDigest = { ...value };
  delete withoutDigest.digest;
  if (hashCanonicalV11(withoutDigest) !== value.digest) {
...
function sameExactObject(actual, expected, keys) {
  return plainObject(actual)
    ...
    && canonicalJsonV11(actual) === canonicalJsonV11(expected);
}

function exactKeys(value, expected) {
  if (!plainObject(value)) return false;
  return canonicalJsonV11(Object.keys(value).sort())
    === canonicalJsonV11([...expected].sort());
}
...
function validateSortedUnique(values, label, errors) {
  ...
  if (new Set(values).size !== values.length
    || canonicalJsonV11(values) !== canonicalJsonV11(sorted)) {
    errors.push(`${label} must be sorted and unique`);
  }
}

function sameStringSet(left, right) {
  return canonicalJsonV11([...new Set(left)].sort())
    === canonicalJsonV11([...new Set(right)].sort());
}

function sameMap(left, right) {
  const project = (value) =>
    [...value.entries()].sort(([a], [b]) => a.localeCompare(b));
  return canonicalJsonV11(project(left)) === canonicalJsonV11(project(right));
}
...
export const canonicalJson = canonicalJsonV11;
export const hashCanonical = hashCanonicalV11;
export const sha256Bytes = sha256BytesV11;
export const validateRound10ReviewRejection = validateRound10ReviewRejectionV11;
export const validateAdmissionCoverage = validateAdmissionCoverageV11;
export const validateContinuationPolicy = validateContinuationPolicyV11;
export const validateBaselineArchive = validateBaselineArchiveV11;
export const validateReviewSnapshotV11 = validateContinuationReviewSnapshotV11;
export const validateReviewSnapshot = validateContinuationReviewSnapshotV11;
export const validateReviewReceiptV11 = validateContinuationReviewReceiptV11;
export const validateReviewSetV11 = validateContinuationReviewSetV11;
export const validateClosureManifestV11 = validateContinuationClosureManifestV11;
export const validateExternalAttestationV11 =
  validateContinuationExternalAttestationV11;
export const validateExternalAnchorV11 = validateContinuationExternalAnchorV11;
